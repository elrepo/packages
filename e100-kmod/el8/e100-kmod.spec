...
# Source code patches
Patch0:		elrepo-e100-extend-ringparam.el8.7.patch
Patch1:		elrepo-e100-netif-napi-add.el8_9.patch
...
%changelog
* Fri May 24 2024 Tuan Hoang <tqhoang@elrepo.org> - 3.5.24-10
- Rebuilt against RHEL 8.10 GA kernel 4.18.0-553.el8_10

* Tue Nov 14 2023 Philip J Perry <phil@elrepo.org> 3.5.24-9
- Rebuilt for RHEL 8.9
- Fix netif_napi_add function

* Sun Jan 15 2023 Philip J Perry <phil@elrepo.org> 3.5.24-8
- Rebuilt against kernel-4.18.0-425.10.1.el8_7 due to a bug in the RHEL kernel
  [https://access.redhat.com/solutions/6985596]

* Tue Nov 15 2022 Philip J Perry <phil@elrepo.org> 3.5.24-7
- Rebuilt for RHEL 8.7
- Fix extend ringparam setting/getting API with rx_buf_len

* Thu Jun 02 2022 Philip J Perry <phil@elrepo.org> 3.5.24-6
- Fix SB-signing issue caused by /usr/lib/rpm/brp-strip
  [https://bugzilla.redhat.com/show_bug.cgi?id=1967291]
- Rebuilt for RHEL8.6
  [https://elrepo.org/bugs/view.php?id=1230]

* Tue May 18 2021 Philip J Perry <phil@elrepo.org> 3.5.24-5
- Rebuilt for RHEL8.4
- Fix updating of initramfs image
  [https://elrepo.org/bugs/view.php?id=1060]

* Wed Nov 04 2020 Philip J Perry <phil@elrepo.org> 3.5.24-4
- Rebuilt for RHEL8.3
- Fix build errors on RHEL8.3

* Tue Apr 28 2020 Philip J Perry <phil@elrepo.org> 3.5.24-3
- Rebuilt for RHEL8.2

* Fri Nov 08 2019 Philip J Perry <phil@elrepo.org> 3.5.24-2
- Rebuilt for RHEL8.1

* Sun Oct 20 2019 Philip J Perry <phil@elrepo.org> 3.5.24-1
