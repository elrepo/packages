...
%{__make} -C %{kernel_source} %{?_smp_mflags} V=1 modules M=$PWD \
	CONFIG_E100=m CONFIG_PCI=y CONFIG_NET_POLL_CONTROLLER=y CONFIG_VLAN_8021Q=m CONFIG_PM=y \
	EXTRA_CFLAGS='-DCONFIG_E100 -DCONFIG_PCI -DCONFIG_NET_POLL_CONTROLLER -DCONFIG_VLAN_8021Q -DCONFIG_PM'
...
%changelog
* Fri May 22 2026 Akemi Yagi <toracat@elrepo.org> - 0.0-6
