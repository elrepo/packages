...
%build
%{__make} -C %{kernel_source} %{?_smp_mflags} modules M=$PWD CONFIG_SATA_MV=m
...
%changelog
* Fri May 24 2024 Tuan Hoang <tqhoang@elrepo.org> - 1.28-6
- Rebuilt against RHEL 8.10 GA kernel 4.18.0-553.el8_10
- ATA source code is unchanged in 8.10

* Sun Nov 19 2023 Tuan Hoang <tqhoang@elrepo.org> - 1.28-5
- Rebuilt against RHEL 8.9 GA kernel
- Source code from kernel-4.18.0-513.5.1.el8_9

* Tue May 16 2023 Akemi Yagi <toracat@elrepo.org> - 1.28-4
- Rebuilt against RHEL 8.8 GA kernel-4.18.0-477.10.1.el8_8
- Source code from kernel-4.18.0-477.10.1.el8_8

* Tue Nov 08 2022 Akemi Yagi <toracat@elrepo.org> - 1.28-3
- Source code from kernel-4.18.0-425.3.1.el8 (8.7 GA)
- Built against RHEL 8.7 GA kernel

* Tue May 10 2022 Akemi Yagi <toracat@elrepo.org> - 1.28-2
...
* Thu Nov 18 2021 Akemi Yagi <toracat@elrepo.org> - 1.28-1
- Initial build for RHEL 8.5
- Source code from kernel-4.18.0-240 (unchanged in 8.5)
