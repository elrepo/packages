...
%{__make} -C %{kernel_source} %{?_smp_mflags} V=1 modules M=$PWD \
	CONFIG_VORTEX=m CONFIG_PCI=y CONFIG_NET_POLL_CONTROLLER=y CONFIG_VLAN_8021Q=m CONFIG_PM=y \
	EXTRA_CFLAGS='-DCONFIG_VORTEX -DCONFIG_PCI -DCONFIG_NET_POLL_CONTROLLER -DCONFIG_VLAN_8021Q -DCONFIG_PM'
...
%changelog
* Wed May 20 2026 Tuan Hoang <tqhoang@elrepo.org> - 0.0-6
- Source code updated from RHEL 9.8 GA kernel
- Built against RHEL 9.8 GA kernel-5.14.0-687.5.3.el9_8

* Fri Jan 02 2026 Tuan Hoang <tqhoang@elrepo.org> - 0.0-5
- Fix problems in posttrans section
- Fix macro usage in files section
- Fix hard-coded arch in post section

* Tue Nov 18 2025 Akemi Yagi <toracat@elrepo.org> - 0.0-4
- Rebuilt against RHEL 9.7 GA kernel

* Wed May 14 2025 Tuan Hoang <tqhoang@elrepo.org> - 0.0-3
- Rebuilt against RHEL 9.6 GA kernel

* Tue Nov 12 2024 Tuan Hoang <tqhoang@elrepo.org> - 0.0-2
- Rebuilt against RHEL 9.5 GA kernel

* Thu May 09 2024 Tuan Hoang <tqhoang@elrepo.org> - 0.0-1
