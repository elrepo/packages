...
Source0: http://github.com/elrepo/packages/tree/master/getinfo/el6/getinfo.sh
Source1: http://github.com/elrepo/packages/tree/master/getinfo/el6/GPL-v2.0.txt
Source2: http://github.com/elrepo/packages/tree/master/getinfo/el6/ReadMe.txt
...
%{__install} -D -m 755 %{SOURCE0} %{buildroot}/usr/local/bin/getinfo.sh
%{__install} -D -m 644 %{SOURCE1} %{buildroot}/usr/local/share/doc/%{name}-%{version}/GPL-v2.0.txt
%{__install} -D -m 644 %{SOURCE2} %{buildroot}/usr/local/share/doc/%{name}-%{version}/ReadMe.txt
