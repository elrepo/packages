...
%build
%{__make} -C %{kernel_source} %{?_smp_mflags} V=1 modules M=$PWD CONFIG_LEDS_PCA9532=m
...
* Tue Nov 15 2022 Akemi Yagi <toracat@elrepo.org> - 0.0-2
- Rebuilt against RHEL 9.1 GA kernel 5.14.0-162.6.1.el9_1

* Wed May 18 2022 Akemi Yagi <toracat@elrepo.org> - 0.0-1
