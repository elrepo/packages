...
%changelog
* Sat May 23 2026 Akemi Yagi <toracat@elrepo.org> - 1.6.12-5
- Rebuilt against RHEL 9.8 GA kernel-5.14.0-687.5.3.el9_8

* Fri Jan 02 2026 Tuan Hoang <tqhoang@elrepo.org> - 1.6.12-4
- Fix problems in posttrans section
- Fix macro usage in files section
- Fix hard-coded arch in post section

* Mon Nov 17 2025 Akemi Yagi <toracat@elrepo.org> - 1.6.12-3
...
* Tue Nov 12 2024 Akemi Yagi <toracat@elrepo.org> - 1.6.10-2
...
* Tue May 09 2023 Akemi Yagi <toracat@elrepo.org> - 1.6.8-2
- Rebuilt against RHEL 9.2 GA kernel 5.14.0-284.11.1.el9_2

* Mon May 09 2022 Akemi Yagi <toracat@elrepo.org> - 1.6.8-1
- Initial build for RHEL 9.1
- Source code submitted by jcpunk
  [https://elrepo.org/bugs/view.php?id=1290]
