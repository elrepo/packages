...
#define HWRM_QRM_COMMON_CMD_ERR_CODE_INVALID_FID          0x64UL
#define HWRM_QRM_COMMON_CMD_ERR_CODE_INVALID_PORT_IDX     0x65UL
#define HWRM_QRM_COMMON_CMD_ERR_CODE_INVALID_FLAG         0x66UL
#define HWRM_QRM_COMMON_CMD_ERR_CODE_INVALID_RX_COSQ_MODE 0x67UL
#define HWRM_QRM_COMMON_CMD_ERR_CODE_INVALID_QUEUE_IDX    0x68UL
#define HWRM_QRM_COMMON_CMD_ERR_CODE_INVALID_COS_FLAG     0x69UL
#define HWRM_QRM_COMMON_CMD_ERR_CODE_ACTIVE_NW_INTF       0x6aUL
#define HWRM_QRM_COMMON_CMD_ERR_CODE_DCBX_AGENT_DISABLED  0x6bUL
#define HWRM_QRM_COMMON_CMD_ERR_CODE_DCBX_AGENT_ENABLED   0x6cUL
#define HWRM_QRM_COMMON_CMD_ERR_CODE_EXCEED_PRI_LVL       0x6dUL
#define HWRM_QRM_COMMON_CMD_ERR_CODE_INVALID_TC           0x6eUL
#define HWRM_QRM_COMMON_CMD_ERR_CODE_NOT_VHOST_PWR_DOMAIN 0x6fUL
#define HWRM_QRM_COMMON_CMD_ERR_CODE_HOST_MEM_READ_FAILED 0x70UL
#define HWRM_QRM_COMMON_CMD_ERR_CODE_LAST                HWRM_QRM_COMMON_CMD_ERR_CODE_HOST_MEM_READ_FAILED
...
/* hwrm_queue_qportcfg_cmd_err (size:64b/8B) */
struct hwrm_queue_qportcfg_cmd_err {
	u8	code;
	#define QUEUE_QPORTCFG_CMD_ERR_CODE_UNKNOWN              0x0UL
	#define QUEUE_QPORTCFG_CMD_ERR_CODE_EXCEED_MAX_CONF_COSQ 0x1UL
	#define QUEUE_QPORTCFG_CMD_ERR_CODE_LAST                QUEUE_QPORTCFG_CMD_ERR_CODE_EXCEED_MAX_CONF_COSQ
	u8	unused_0[7];
};
...
/* hwrm_queue_cfg_cmd_err (size:64b/8B) */
struct hwrm_queue_cfg_cmd_err {
	u8	code;
	#define QUEUE_CFG_CMD_ERR_CODE_UNKNOWN                 0x0UL
	#define QUEUE_CFG_CMD_ERR_CODE_SERVICE_PROFILE_NOT_SET 0x1UL
	#define QUEUE_CFG_CMD_ERR_CODE_INVALID_SERVICE_PROFILE 0x2UL
	#define QUEUE_CFG_CMD_ERR_CODE_INVALID_HOST_MASK       0x3UL
	#define QUEUE_CFG_CMD_ERR_CODE_LAST                   QUEUE_CFG_CMD_ERR_CODE_INVALID_HOST_MASK
	u8	unused_0[7];
};
...
/* hwrm_queue_pri2cos_cfg_cmd_err (size:64b/8B) */
struct hwrm_queue_pri2cos_cfg_cmd_err {
	u8	code;
	#define QUEUE_PRI2COS_CFG_CMD_ERR_CODE_UNKNOWN                0x0UL
	#define QUEUE_PRI2COS_CFG_CMD_ERR_CODE_TUNNEL_MAP_UNSUPPORTED 0x1UL
	#define QUEUE_PRI2COS_CFG_CMD_ERR_CODE_INVALID_COS_IDX        0x2UL
	#define QUEUE_PRI2COS_CFG_CMD_ERR_CODE_INVALID_COS_PORT       0x3UL
	#define QUEUE_PRI2COS_CFG_CMD_ERR_CODE_RSVD_COS_IDX           0x4UL
	#define QUEUE_PRI2COS_CFG_CMD_ERR_CODE_LAST                  QUEUE_PRI2COS_CFG_CMD_ERR_CODE_RSVD_COS_IDX
	u8	unused_0[7];
};
...
/* hwrm_queue_cos2bw_cfg_cmd_err (size:64b/8B) */
struct hwrm_queue_cos2bw_cfg_cmd_err {
	u8	code;
	#define QUEUE_COS2BW_CFG_CMD_ERR_CODE_UNKNOWN            0x0UL
	#define QUEUE_COS2BW_CFG_CMD_ERR_CODE_INVALID_TSA_ASSIGN 0x1UL
	#define QUEUE_COS2BW_CFG_CMD_ERR_CODE_EXCEED_BW_WEIGHT   0x2UL
	#define QUEUE_COS2BW_CFG_CMD_ERR_CODE_INVALID_BW         0x3UL
	#define QUEUE_COS2BW_CFG_CMD_ERR_CODE_INVALID_THRESHOLD  0x4UL
	#define QUEUE_COS2BW_CFG_CMD_ERR_CODE_DUP_QUEUE_ID       0x5UL
	#define QUEUE_COS2BW_CFG_CMD_ERR_CODE_LAST              QUEUE_COS2BW_CFG_CMD_ERR_CODE_DUP_QUEUE_ID
	u8	unused_0[7];
};
...
/* hwrm_queue_dscp2pri_qcfg_cmd_err (size:64b/8B) */
struct hwrm_queue_dscp2pri_qcfg_cmd_err {
	u8	code;
	#define QUEUE_DSCP2PRI_QCFG_CMD_ERR_CODE_UNKNOWN              0x0UL
	#define QUEUE_DSCP2PRI_QCFG_CMD_ERR_CODE_INVLD_DEST_BUF_ADDR  0x1UL
	#define QUEUE_DSCP2PRI_QCFG_CMD_ERR_CODE_INVLD_DEST_BUF_SIZE  0x2UL
	#define QUEUE_DSCP2PRI_QCFG_CMD_ERR_CODE_INSUFF_DEST_BUF_SIZE 0x3UL
	#define QUEUE_DSCP2PRI_QCFG_CMD_ERR_CODE_LAST                QUEUE_DSCP2PRI_QCFG_CMD_ERR_CODE_INSUFF_DEST_BUF_SIZE
	u8	unused_0[7];
};
...
/* hwrm_queue_dscp2pri_cfg_cmd_err (size:64b/8B) */
struct hwrm_queue_dscp2pri_cfg_cmd_err {
	u8	code;
	#define QUEUE_DSCP2PRI_CFG_CMD_ERR_CODE_UNKNOWN                 0x0UL
	#define QUEUE_DSCP2PRI_CFG_CMD_ERR_CODE_INV_PRI2COS_DESTQ_CFG   0x1UL
	#define QUEUE_DSCP2PRI_CFG_CMD_ERR_CODE_DEST_QUEUE_INVALID_MASK 0x2UL
	#define QUEUE_DSCP2PRI_CFG_CMD_ERR_CODE_LAST                   QUEUE_DSCP2PRI_CFG_CMD_ERR_CODE_DEST_QUEUE_INVALID_MASK
	u8	unused_0[7];
};
...
/* hwrm_queue_global_cfg_cmd_err (size:64b/8B) */
struct hwrm_queue_global_cfg_cmd_err {
	u8	code;
	#define QUEUE_GLOBAL_CFG_CMD_ERR_CODE_UNKNOWN                  0x0UL
	#define QUEUE_GLOBAL_CFG_CMD_ERR_CODE_EXCEED_RX_RATE_LIMIT_MAX 0x1UL
	#define QUEUE_GLOBAL_CFG_CMD_ERR_CODE_LAST                    QUEUE_GLOBAL_CFG_CMD_ERR_CODE_EXCEED_RX_RATE_LIMIT_MAX
	u8	unused_0[7];
};
...
/* hwrm_queue_pfcwd_timeout_cfg_cmd_err (size:64b/8B) */
struct hwrm_queue_pfcwd_timeout_cfg_cmd_err {
	u8	code;
	#define QUEUE_PFCWD_TIMEOUT_CFG_CMD_ERR_CODE_UNKNOWN         0x0UL
	#define QUEUE_PFCWD_TIMEOUT_CFG_CMD_ERR_CODE_PFC_WD_DISABLED 0x1UL
	#define QUEUE_PFCWD_TIMEOUT_CFG_CMD_ERR_CODE_EXCEED_TIMEOUT  0x2UL
	#define QUEUE_PFCWD_TIMEOUT_CFG_CMD_ERR_CODE_LAST           QUEUE_PFCWD_TIMEOUT_CFG_CMD_ERR_CODE_EXCEED_TIMEOUT
	u8	unused_0[7];
};
