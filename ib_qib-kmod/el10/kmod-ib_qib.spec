...
# Source code patches.
Patch0: 	0001-RDMA-qib-Constify-struct-bin_attribute.patch
Patch1: 	0002-qibfs-fix-_another_-leak.patch
...
%{__make} -C %{kernel_source} %{?_smp_mflags} V=1 modules M=$PWD \
	...
	EXTRA_CFLAGS+='-DCONFIG_INFINIBAND_QIB' \
	EXTRA_CFLAGS+='-DCONFIG_INFINIBAND_QIB_DCA' \
...
%changelog
* Wed May 20 2026 Tuan Hoang <tqhoang@elrepo.org> - 1.11-2
- Source code updated from RHEL 10.2 GA kernel
- Built against RHEL 10.2 GA kernel-6.12.0-211.7.3.el10_2
- Add patches from upstream linux-6.16.y

* Mon Jan 19 2026 Tuan Hoang <tqhoang@elrepo.org> - 1.11-1
- Initial build for RHEL 10.1
- Source code from RHEL 10.1 GA kernel 6.12.0-124.8.1.el10_1
- ELRepo request-for-enhancement
  [https://elrepo.org/bugs/view.php?id=1580]
