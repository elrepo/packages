...
#define BNXT_ROCE_MSIX_VF_DEFAULT	2
#define BNXT_MAX_ROCE_MSIX_NPAR_PF	5
#define BNXT_MAX_ROCE_MSIX		256
#define BNXT_ROCE_MSIX_DEFAULT		64
#ifdef BNXT_FPGA
#define BNXT_MAX_ROCE_MSIX_PF		9
#endif

#define BNXT_MAX_ROCE_TS_QPS		2
...
/* ULP Resource reservation types */
enum bnxt_ulp_resc_type {
	BNXT_ULP_RES_MSIX = 0,
	BNXT_ULP_RES_STAT_CTX,
	BNXT_ULP_RES_RX,
	BNXT_ULP_RES_TX,
	BNXT_ULP_RES_CP,
	BNXT_ULP_RES_VNIC,
	BNXT_ULP_RES_RSS_CTX,
	__BNXT_ULP_RES_MAX,
};
...
#define BNXT_EN_SW_RES_LMT(edev)	((edev)->flags & BNXT_EN_FLAG_SW_RES_LMT)
	...
	u32				ulp_version;	/* bnxt_re checks the
							 ...
							 * with bnxt_en.
							 */
	#define BNXT_ULP_VERSION	0x695a0017	/* Change this when any interface
...
#define BNXT_EN_NPAR(edev)		((edev)->port_partition_type)
	...
	u16				ulp_resc[__BNXT_ULP_RES_MAX]; /* Resources
								       * rsvd for RoCE
								       */
...
void bnxt_set_ulp_resc(struct bnxt *bp, enum bnxt_ulp_resc_type type, u16 num);
