...
int bnxt_tf_l2_filter_delete(struct bnxt *bp,
			     struct bnxt_l2_filter *fltr);
#else
static inline int bnxt_ulp_nic_flows_roce_add(struct bnxt *bp,
					      struct ulp_nic_flows *flows,
					      enum cfa_dir dir) { return 0; }
static inline int bnxt_ulp_nic_flows_roce_del(struct bnxt *bp,
					      struct ulp_nic_flows *flows,
					      enum cfa_dir dir) { return 0; }
static inline int bnxt_tf_ntuple_flow_create(struct bnxt *bp,
					     struct bnxt_ntuple_filter *fltr,
					     u32 *flow_id, u64 *flow_cnt_hndl,
					     enum cfa_dir dir) { return 0; }
static inline int bnxt_tf_ntuple_flow_del(struct bnxt *bp,
					  struct bnxt_ntuple_filter *fltr) { return 0; }
static inline int bnxt_tf_tls_flow_create(struct bnxt *bp, struct sock *sk,
					  u64 *flow_id, u64 *flow_cnt_hndl,
					  u32 kid, u8 type) { return 0; }
static inline int bnxt_tf_tls_flow_del(struct bnxt *bp, __le64 filter_id) { return 0; }
static inline int bnxt_tf_l2_filter_create(struct bnxt *bp,
					   struct bnxt_l2_filter *fltr) { return 0; }
static inline int bnxt_tf_l2_filter_delete(struct bnxt *bp,
					   struct bnxt_l2_filter *fltr) { return 0; }
