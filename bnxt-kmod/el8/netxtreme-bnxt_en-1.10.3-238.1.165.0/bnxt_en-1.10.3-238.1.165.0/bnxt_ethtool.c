...
static int __bnxt_get_module_status(struct bnxt *bp)
{
	int rc;
			     ...
			     struct netlink_ext_ack *extack)
{
	...
	if (BNXT_COAL_GET_CQE(bp, hw_coal))
	...
	if ((kernel_coal->use_cqe_mode_rx || kernel_coal->use_cqe_mode_tx) &&
	    !(bp->coal_cap.cmpl_params &
	      (RING_AGGINT_QCAPS_RESP_CMPL_PARAMS_TIMER_RESET |
	       RING_AGGINT_QCAPS_RESP_CMPL_PARAMS_TMR_RESET_ON_ALLOC)))
		return -EOPNOTSUPP;
#endif
...
#ifdef HAVE_CQE_ETHTOOL_COALESCE
	prev_flags = hw_coal->ring_alloc_flags;
	BNXT_COAL_CLEAR_CQE(bp, hw_coal);
	if (kernel_coal->use_cqe_mode_rx)
		BNXT_COAL_SET_CQE(bp, hw_coal);
	if (hw_coal->ring_alloc_flags != prev_flags)
		need_reset = true;
#endif
...
/* kTLS counter strings indexed by enum bnxt_ktls_counters */
static const char *const bnxt_ktls_stats[] = {
	[BNXT_KTLS_TX_ADD]			= "ktls_tx_add",
	[BNXT_KTLS_TX_DEL]			= "ktls_tx_del",
	[BNXT_KTLS_TX_HW_PKT]			= "ktls_tx_hw_pkt",
	[BNXT_KTLS_TX_SW_PKT]			= "ktls_tx_sw_pkt",
	[BNXT_KTLS_TX_OOO]			= "ktls_tx_tls_ooo",
	[BNXT_KTLS_TX_RETRANS]			= "ktls_tx_retrans_pkt",
	[BNXT_KTLS_TX_REPLAY]			= "ktls_tx_replay",
	[BNXT_KTLS_TX_REC_ERR]			= "ktls_tx_rec_err",
	[BNXT_KTLS_TX_SEQ_FWD]			= "ktls_tx_seq_fwd",
	[BNXT_KTLS_RX_ADD]			= "ktls_rx_add",
	[BNXT_KTLS_RX_DEL]			= "ktls_rx_del",
	[BNXT_KTLS_RX_HW_PKT]			= "ktls_rx_hw_pkt",
	[BNXT_KTLS_RX_SW_PKT]			= "ktls_rx_sw_pkt",
	[BNXT_KTLS_RX_RESYNC_REQ]		= "ktls_rx_resync_req",
	[BNXT_KTLS_RX_RESYNC_ACK]		= "ktls_rx_resync_ack",
	[BNXT_KTLS_RX_RESYNC_DISCARD]		= "ktls_rx_resync_discard",
	[BNXT_KTLS_RX_RESYNC_NAK]		= "ktls_rx_resync_nak",
	[BNXT_KTLS_ERR_NO_MEM]			= "ktls_err_no_mem",
	[BNXT_KTLS_ERR_KEY_CTX_ALLOC]		= "ktls_err_key_ctx_alloc",
	[BNXT_KTLS_ERR_CRYPTO_CMD]		= "ktls_err_crypto_cmd",
	[BNXT_KTLS_ERR_FILTER_ALLOC]		= "ktls_err_filter_alloc",
	[BNXT_KTLS_ERR_FILTER_LIMIT]		= "ktls_err_filter_limit",
	[BNXT_KTLS_ERR_DEVICE_BUSY]		= "ktls_err_device_busy",
	[BNXT_KTLS_ERR_INVALID_CIPHER]		= "ktls_err_invalid_cipher",
	[BNXT_KTLS_ERR_STATE_NOT_OPEN]		= "ktls_err_state_not_open",
	[BNXT_KTLS_ERR_RETRY_EXCEEDED]		= "ktls_err_retry_exceeded",
};

static const char *const bnxt_db_error_qstats[] = {
	"express_db_dropped_misc_error",
	"express_db_dropped_rq_overflow",
	"express_db_dropped_sq_overflow",
	"rx_db_drop_invalid_rq_state",
	"tx_db_drop_invalid_qp_state",
	"tx_db_drop_format_error",
};

/* QUIC counter strings indexed by enum bnxt_quic_counters */
static const char *const bnxt_quic_stats[] = {
	[BNXT_QUIC_ACTIVE_FLOWS]		= "quic_active_flows",
	[BNXT_QUIC_TX_ADD]			= "quic_tx_add",
	[BNXT_QUIC_TX_DEL]			= "quic_tx_del",
	[BNXT_QUIC_RX_ADD]			= "quic_rx_add",
	[BNXT_QUIC_RX_DEL]			= "quic_rx_del",
	[BNXT_QUIC_ERR_ADD_FLOW]		= "quic_err_add_flow",
	[BNXT_QUIC_ERR_DEL_FLOW]		= "quic_err_del_flow",
	[BNXT_QUIC_ERR_DUPLICATE_FLOW]		= "quic_err_duplicate_flow",
	[BNXT_QUIC_ERR_NO_MEM]			= "quic_err_no_mem",
	[BNXT_QUIC_ERR_KEY_CTX_ALLOC]		= "quic_err_key_ctx_alloc",
	[BNXT_QUIC_ERR_CRYPTO_CMD]		= "quic_err_crypto_cmd",
	[BNXT_QUIC_ERR_FILTER_ALLOC]		= "quic_err_filter_alloc",
	[BNXT_QUIC_ERR_INVALID_PARAM]		= "quic_err_invalid_param",
	[BNXT_QUIC_ERR_DEVICE_BUSY]		= "quic_err_device_busy",
	[BNXT_QUIC_ERR_FLOW_NOT_FOUND]		= "quic_err_flow_not_found",
	[BNXT_QUIC_TX_HW_PKT]			= "quic_tx_hw_pkt",
	[BNXT_QUIC_TX_LOOKUP_FLOW_MISS]		= "quic_tx_lookup_flow_miss",
	[BNXT_QUIC_TX_LOOKUP_KEY_PHASE_MISS]    = "quic_tx_lookup_key_phase_miss",
	[BNXT_QUIC_RX_HW_PKT]			= "quic_rx_hw_pkt",
	[BNXT_QUIC_RX_PAYLOAD_DECRYPTED]	= "quic_rx_payload_decrypted",
	[BNXT_QUIC_RX_HDR_DECRYPTED]		= "quic_rx_hdr_decrypted",
	[BNXT_QUIC_RX_KEY_PHASE_MISMATCH]	= "quic_rx_key_phase_mismatch",
	[BNXT_QUIC_RX_RUNT]			= "quic_rx_runt",
	[BNXT_QUIC_RX_SHORT_HDR]		= "quic_rx_short_hdr",
	[BNXT_QUIC_RX_LONG_HDR]			= "quic_rx_long_hdr",
};
...
static int bnxt_get_num_ring_stats(struct bnxt *bp)
{
	...
	return rx * bp->rx_nr_rings +
	       tx * (BNXT_TX_XDP_RINGS_PER_GRP(bp) + bp->tx_nr_rings_per_tc) +
	       cmn * bp->cp_nr_rings +
	       xsk * bp->cp_nr_rings;
}
...
static int bnxt_skip_port_stats_ext_count(struct bnxt *bp)
{
	...
	if (bp->stats_cap & BNXT_STATS_CAP_PFC_ADV)
		return 0;
...
skip_ring_stats:
	...
	if (bp->quic_info) {
		...
		/* Atomic counters: indices 0 to BNXT_QUIC_PERCPU_START-1 */
		for (counter_idx = 0; counter_idx < BNXT_QUIC_PERCPU_START;
		     counter_idx++, j++) {
			buf[j] = atomic64_read(&quic->counters[counter_idx]);
		}

		/* Per-CPU counters: indices BNXT_QUIC_PERCPU_START to MAX-1 */
		for (counter_idx = BNXT_QUIC_PERCPU_START;
		     counter_idx < BNXT_QUIC_MAX_COUNTERS; counter_idx++, j++) {
			buf[j] = bnxt_quic_get_percpu_counter(quic, counter_idx);
		}
	}
	if (bp->stats_cap & BNXT_STATS_CAP_PORT) {
			      ...
			      struct ethtool_channels *channel)
{
	...
	_bnxt_get_max_rings(bp, &max_rx_rings, &max_tx_rings, &max_cp_rings);
	...
	if (bp->tx_nr_rings_xdp) {
		tx_grps += BNXT_XDP_TX_PER_NAPI;
		max_cp_rings >>= 1;
	}
	max_tx_rings /= tx_grps;
	channel->max_combined = min3(max_tx_rings, max_rx_rings, max_cp_rings);
...
static int bnxt_check_etf_tx_rings(struct bnxt *bp, int tx, int tcs)
{
			     ...
			     struct ethtool_channels *channel)
{
	...
	if (bp->tx_nr_rings_xdp) {
		...
		tx_xdp = req_rx_rings * BNXT_XDP_TX_PER_NAPI;
	}

#if defined(HAVE_ETF_QOPT_OFFLOAD)
	rc = bnxt_check_etf_tx_rings(bp, req_tx_rings, tcs);
	if (rc)
		return rc;
#endif
...
static const enum bnxt_media_type bnxt_phy_types[] = {
	...
	[PORT_PHY_QCFG_RESP_PHY_TYPE_400G_BASEDR4] = BNXT_MEDIA_DR,
	[PORT_PHY_QCFG_RESP_PHY_TYPE_400G_BASEFR4] = BNXT_MEDIA_LR_ER_FR,
};
...
bnxt_link_modes[__BNXT_LINK_SPEED_END][BNXT_SIG_MODE_MAX][__BNXT_MEDIA_END] = {
	...
	[BNXT_LINK_SPEED_50GB_IDX] = {
		...
		[BNXT_SIG_MODE_PAM4] = {
			...
			[BNXT_MEDIA_DR] = ETHTOOL_LINK_MODE_50000baseDR_Full_BIT,
	...
	[BNXT_LINK_SPEED_100GB_IDX] = {
		...
		[BNXT_SIG_MODE_PAM4] = {
			...
			[BNXT_MEDIA_DR] = ETHTOOL_LINK_MODE_100000baseDR2_Full_BIT,
		...
		[BNXT_SIG_MODE_PAM4_112] = {
			...
			[BNXT_MEDIA_DR] = ETHTOOL_LINK_MODE_100000baseDR_Full_BIT,
	...
	[BNXT_LINK_SPEED_200GB_IDX] = {
		[BNXT_SIG_MODE_PAM4] = {
			...
			[BNXT_MEDIA_DR] = ETHTOOL_LINK_MODE_200000baseDR4_Full_BIT,
		...
		[BNXT_SIG_MODE_PAM4_112] = {
			...
			[BNXT_MEDIA_DR] = ETHTOOL_LINK_MODE_200000baseDR2_Full_BIT,
	...
	[BNXT_LINK_SPEED_400GB_IDX] = {
		[BNXT_SIG_MODE_PAM4] = {
			...
			[BNXT_MEDIA_DR] = ETHTOOL_LINK_MODE_400000baseDR8_Full_BIT,
		...
		[BNXT_SIG_MODE_PAM4_112] = {
			...
			[BNXT_MEDIA_DR] = ETHTOOL_LINK_MODE_400000baseDR4_Full_BIT,
...
#ifdef HAVE_ETHTOOL_LINK_EXT_STATE_NEW
				...
				struct ethtool_modinfo *modinfo)
{
	...
	rc = __bnxt_get_module_status(bp);
	if (rc)
		return rc;
...
void bnxt_ethtool_init(struct bnxt *bp)
{
	...
	for (i = 0; i < bp->num_tests; i++) {
		...
		if (i == BNXT_MACLPBK_TEST_IDX) {
			strscpy(str, "Mac loopback test (offline)", ETH_GSTRING_LEN);
		} else if (i == BNXT_PHYLPBK_TEST_IDX) {
			strscpy(str, "Phy loopback test (offline)", ETH_GSTRING_LEN);
		} else if (i == BNXT_EXTLPBK_TEST_IDX) {
			strscpy(str, "Ext loopback test (offline)", ETH_GSTRING_LEN);
		} else if (i == BNXT_IRQ_TEST_IDX) {
			strscpy(str, "Interrupt_test (online)", ETH_GSTRING_LEN);
		} else {
