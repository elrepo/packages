...
struct bnxt_ulp_mapper_tbl_info ulp_thor2_act_tbl_list[] = {
	...
	{ /* act_tid: 1, , table: sp_smac_only.mpls_pop */
	.description = "sp_smac_only.mpls_pop",
	.resource_func = BNXT_ULP_RESOURCE_FUNC_CMM_TABLE,
	.resource_type = CFA_RSUBTYPE_CMM_ACT,
	.resource_sub_type =
		BNXT_ULP_RESOURCE_SUB_TYPE_CMM_TABLE_ACT,
	...
	{ /* act_tid: 1, , table: control.srp_mpls_pop */
	.description = "control.srp_mpls_pop",
	.resource_func = BNXT_ULP_RESOURCE_FUNC_CTRL_TABLE,
	.direction = TF_DIR_RX,
	.execute_info = {
		.cond_true_goto  = 1,
	...
	{ /* act_tid: 1, , table: ext_tun_l2_encap_record.mpls_pop */
	.description = "ext_tun_l2_encap_record.mpls_pop",
	.resource_func = BNXT_ULP_RESOURCE_FUNC_CMM_TABLE,
	.resource_type = CFA_RSUBTYPE_CMM_ACT,
	.resource_sub_type =
		BNXT_ULP_RESOURCE_SUB_TYPE_CMM_TABLE_ACT,
	...
	{ /* act_tid: 7, , table: control.mpls_push_checks */
	.description = "control.mpls_push_checks",
	.resource_func = BNXT_ULP_RESOURCE_FUNC_CTRL_TABLE,
	.direction = TF_DIR_TX,
	.execute_info = {
		.cond_true_goto  = 30,
	...
	{ /* act_tid: 7, , table: sp_smac_only.mpls_push */
	.description = "sp_smac_only.mpls_push",
	.resource_func = BNXT_ULP_RESOURCE_FUNC_CMM_TABLE,
	.resource_type = CFA_RSUBTYPE_CMM_ACT,
	.resource_sub_type =
		BNXT_ULP_RESOURCE_SUB_TYPE_CMM_TABLE_ACT,
	...
	{ /* act_tid: 7, , table: control.srp_mpls_push */
	.description = "control.srp_mpls_push",
	.resource_func = BNXT_ULP_RESOURCE_FUNC_CTRL_TABLE,
	.direction = TF_DIR_TX,
	.execute_info = {
		.cond_true_goto  = 1,
	...
	{ /* act_tid: 7, , table: ext_mpls_gen_encap_record.0 */
	.description = "ext_mpls_gen_encap_record.0",
	.resource_func = BNXT_ULP_RESOURCE_FUNC_CMM_TABLE,
	.resource_type = CFA_RSUBTYPE_CMM_ACT,
	.resource_sub_type =
		BNXT_ULP_RESOURCE_SUB_TYPE_CMM_TABLE_ACT,
	...
	{ /* act_tid: 7, , table: control.mpls_enc_handle_to_offset */
	.description = "control.mpls_enc_handle_to_offset",
	.resource_func = BNXT_ULP_RESOURCE_FUNC_CTRL_TABLE,
	.direction = TF_DIR_TX,
	.execute_info = {
		.cond_true_goto  = 1,
...
struct bnxt_ulp_mapper_cond_list_info ulp_thor2_act_cond_oper_list[] = {
	/* cond_execute: act_tid: 7, control.mpls_push_checks:81*/
	{
		.cond_list_opcode = BNXT_ULP_COND_LIST_OPC_AND,
		.cond_start_idx = 81,
		.cond_nums = 1
...
struct bnxt_ulp_mapper_cond_info ulp_thor2_act_cond_list[] = {
	...
	/* cond_execute: act_tid: 1, sp_smac_only.mpls_pop:18*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_POP_MPLS
	},
	/* cond_execute: act_tid: 1, ext_tun_l2_encap_record.mpls_pop:19*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_POP_MPLS
	},
	...
	/* field_cond: act_tid: 1, cmm_full_act_record.0:26*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_POP_MPLS
	},
	/* field_cond: act_tid: 1, cmm_full_act_record.0:27*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_PROP_IS_SET,
	.cond_operand = BNXT_ULP_ACT_PROP_IDX_POP_MPLS_DEPTH
	},
	/* cond_execute: act_tid: 3, control.delete_chk:28*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_DELETE
	},
	/* cond_execute: act_tid: 3, control.mirror_del_exist_chk:29*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_RF_IS_SET,
	.cond_operand = BNXT_ULP_RF_IDX_GENERIC_TBL_MISS
	},
	/* cond_execute: act_tid: 3, control.mirror_ref_cnt_chk:30*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_RF_IS_SET,
	.cond_operand = BNXT_ULP_RF_IDX_CC
	},
	/* cond_execute: act_tid: 3, cmm_stat_record.0:31*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_COUNT
	},
	/* cond_execute: act_tid: 6, control.create_check:32*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_NOT_SET,
	...
	/* cond_execute: act_tid: 6, meter_profile_tbl_cache.rd:34*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_METER_PROFILE
	},
	/* cond_execute: act_tid: 6, control.shared_meter_profile_0:35*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_RF_IS_SET,
	.cond_operand = BNXT_ULP_RF_IDX_GENERIC_TBL_MISS
	},
	/* cond_execute: act_tid: 6, shared_meter_tbl_cache.rd:36*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_SHARED_METER
	},
	/* cond_execute: act_tid: 6, control.meter_created_chk:37*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_RF_IS_SET,
	.cond_operand = BNXT_ULP_RF_IDX_GENERIC_TBL_MISS
	},
	/* cond_execute: act_tid: 6, control.shared_meter_profile_chk:38*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_RF_IS_SET,
	.cond_operand = BNXT_ULP_RF_IDX_GENERIC_TBL_MISS
	},
	/* cond_execute: act_tid: 6, control.delete_check:39*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_DELETE
	},
	/* cond_execute: act_tid: 6, meter_profile_tbl_cache.del_chk:40*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_METER_PROFILE
	},
	/* cond_execute: act_tid: 6, control.mtr_prof_ref_cnt_chk:41*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_RF_IS_SET,
	.cond_operand = BNXT_ULP_RF_IDX_CC
	},
	/* cond_execute: act_tid: 6, shared_meter_tbl_cache.del_chk:42*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_SHARED_METER
	},
	/* cond_execute: act_tid: 6, control.shared_mtr_ref_cnt_chk:43*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_RF_IS_SET,
	.cond_operand = BNXT_ULP_RF_IDX_CC
	},
	/* cond_execute: act_tid: 6, shared_meter_tbl_cache.rd_update:44*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_SHARED_METER
	},
	/* cond_execute: act_tid: 6, meter_tbl.update_rd:45*/
	{
	...
	/* cond_execute: act_tid: 7, cmm_stat_record.mirror:52*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_COUNT
	},
	/* cond_execute: act_tid: 7, control.do_mod:53*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_RF_IS_SET,
	.cond_operand = BNXT_ULP_RF_IDX_RF_0
	},
	/* cond_execute: act_tid: 7, control.vf_to_vf_calc:54*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_VF_TO_VF
	},
	/* cond_execute: act_tid: 7, mod_record.ttl_0:55*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_DEC_TTL
	},
	...
	/* field_cond: act_tid: 7, mod_record.ttl_0:65*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_GOTO_CHAIN
	},
	/* cond_execute: act_tid: 7, mod_record.non_ttl_0:66*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_NOT_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_DEC_TTL
	},
	...
	/* field_cond: act_tid: 7, mod_record.non_ttl_0:76*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_GOTO_CHAIN
	},
	/* cond_execute: act_tid: 7, control.do_tunnel_check:77*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	...
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_PUSH_MPLS
	},
	/* cond_execute: act_tid: 7, control.do_tunnel_vlan_exclusion:80*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	...
	/* cond_execute: act_tid: 7, source_property_cache.rd:82*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_CF_IS_SET,
	.cond_operand = BNXT_ULP_CF_IDX_ACT_ENCAP_IPV4_FLAG
	},
	/* cond_execute: act_tid: 7, control.sp_rec_v4:83*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_RF_IS_SET,
	.cond_operand = BNXT_ULP_RF_IDX_GENERIC_TBL_MISS
	},
	/* cond_execute: act_tid: 7, source_property_ipv6_cache.rd:84*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_CF_IS_SET,
	.cond_operand = BNXT_ULP_CF_IDX_ACT_ENCAP_IPV6_FLAG
	},
	/* cond_execute: act_tid: 7, control.sp_rec_v6:85*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_RF_IS_SET,
	.cond_operand = BNXT_ULP_RF_IDX_GENERIC_TBL_MISS
	},
	...
	/* cond_execute: act_tid: 7, sp_smac_only.mpls_push:96*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_PUSH_MPLS
	},
	/* cond_execute: act_tid: 7, ext_mpls_gen_encap_record.0:97*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_PUSH_MPLS
	},
	/* field_cond: act_tid: 7, ext_mpls_gen_encap_record.0:98*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_CF_BIT_IS_SET,
	.cond_operand = BNXT_ULP_CF_BIT_MPLS_PUSH_1
	},
	/* field_cond: act_tid: 7, ext_mpls_gen_encap_record.0:99*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_CF_BIT_IS_SET,
	.cond_operand = BNXT_ULP_CF_BIT_MPLS_PUSH_1
	},
	/* field_cond: act_tid: 7, ext_mpls_gen_encap_record.0:100*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_CF_BIT_IS_SET,
	.cond_operand = BNXT_ULP_CF_BIT_MPLS_PUSH_1
	},
	/* field_cond: act_tid: 7, ext_mpls_gen_encap_record.0:101*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_CF_BIT_IS_SET,
	.cond_operand = BNXT_ULP_CF_BIT_MPLS_PUSH_1
	},
	/* field_cond: act_tid: 7, ext_mpls_gen_encap_record.0:102*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_CF_BIT_IS_SET,
	.cond_operand = BNXT_ULP_CF_BIT_MPLS_PUSH_1
	},
	/* field_cond: act_tid: 7, cmm_full_act_record.0:103*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_GOTO_CHAIN
	},
	/* field_cond: act_tid: 7, cmm_full_act_record.0:104*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_VF_TO_VF
	},
	...
	/* cond_execute: act_tid: 12, cmm_stat_record.0:109*/
	{
	.cond_opcode = BNXT_ULP_COND_OPC_ACT_BIT_IS_SET,
	.cond_operand = BNXT_ULP_ACT_BIT_COUNT
	}
...
struct bnxt_ulp_mapper_field_info ulp_thor2_act_key_ext_list[] = {
	...
	.field_src2 = BNXT_ULP_FIELD_SRC_CONST,
	.field_opr2 = {
	ULP_THOR2_SYM_DECAP_FUNC_DECAP_TWO_MPLS_OUTER_L2},
	.field_src3 = BNXT_ULP_FIELD_SRC_CONST,
	.field_opr3 = {
	ULP_THOR2_SYM_DECAP_FUNC_DECAP_ONE_MPLS_OUTER_L2}
		},
	{
...
struct bnxt_ulp_mapper_field_info ulp_thor2_act_result_field_list[] = {
	...
	{
	.description = "update_en",
	.field_bit_size = 1,
	.field_opc = BNXT_ULP_FIELD_OPC_SRC1_THEN_SRC2_ELSE_SRC3,
	.field_src1 = BNXT_ULP_FIELD_SRC_ACT_BIT,
	.field_opr1 = {
	((uint64_t)BNXT_ULP_ACT_BIT_UPDATE_KID >> 56) & 0xff,
	((uint64_t)BNXT_ULP_ACT_BIT_UPDATE_KID >> 48) & 0xff,
	((uint64_t)BNXT_ULP_ACT_BIT_UPDATE_KID >> 40) & 0xff,
	((uint64_t)BNXT_ULP_ACT_BIT_UPDATE_KID >> 32) & 0xff,
	((uint64_t)BNXT_ULP_ACT_BIT_UPDATE_KID >> 24) & 0xff,
	((uint64_t)BNXT_ULP_ACT_BIT_UPDATE_KID >> 16) & 0xff,
	((uint64_t)BNXT_ULP_ACT_BIT_UPDATE_KID >> 8) & 0xff,
	(uint64_t)BNXT_ULP_ACT_BIT_UPDATE_KID & 0xff},
	.field_src2 = BNXT_ULP_FIELD_SRC_CONST,
	.field_opr2 = {
	1},
	.field_src3 = BNXT_ULP_FIELD_SRC_ZERO
	...
	{
	.description = "update_reserved_en",
	.field_bit_size = 15,
	.field_opc = BNXT_ULP_FIELD_OPC_SRC1_THEN_SRC2_ELSE_SRC3,
	.field_src1 = BNXT_ULP_FIELD_SRC_ACT_BIT,
	.field_opr1 = {
	...
	.field_opr2 = {
	(BNXT_ULP_ACT_PROP_IDX_UPDATE_KID >> 8) & 0xff,
	BNXT_ULP_ACT_PROP_IDX_UPDATE_KID & 0xff},
	.field_src3 = BNXT_ULP_FIELD_SRC_SKIP
	},
	{
	.description = "l2_dmac",
	...
	{
	.description = "ipv4_id_ctrl",
	.field_bit_size = 2,
	.field_opc = BNXT_ULP_FIELD_OPC_SRC1,
	.field_src1 = BNXT_ULP_FIELD_SRC_ZERO
	},
	{
	.description = "smac_ovr",
	.field_bit_size = 3,
	.field_opc = BNXT_ULP_FIELD_OPC_SRC1,
	.field_src1 = BNXT_ULP_FIELD_SRC_CONST,
	.field_opr1 = {
	ULP_THOR2_SYM_TECT_SMAC_OVR_REUSE_TUNNEL_SMAC}
	},
	{
	.description = "vlan_ovr",
	.field_bit_size = 3,
	.field_opc = BNXT_ULP_FIELD_OPC_SRC1,
	.field_src1 = BNXT_ULP_FIELD_SRC_ZERO
	},
	{
	.description = "dmac_ovr",
	.field_bit_size = 2,
	.field_opc = BNXT_ULP_FIELD_OPC_SRC1,
	.field_src1 = BNXT_ULP_FIELD_SRC_CONST,
	.field_opr1 = {
	ULP_THOR2_SYM_TECT_DMAC_OVR_REUSE_TUNNEL_DMAC}
	},
	{
	.description = "gre_set_k",
	.field_bit_size = 1,
	.field_opc = BNXT_ULP_FIELD_OPC_SRC1,
	.field_src1 = BNXT_ULP_FIELD_SRC_ZERO
	},
	...
	{
	.description = "ip_tos_ih",
	.field_bit_size = 1,
	.field_opc = BNXT_ULP_FIELD_OPC_SRC1,
	.field_src1 = BNXT_ULP_FIELD_SRC_ZERO
	},
	{
	.description = "ip_ttl_ih",
	.field_bit_size = 1,
	.field_opc = BNXT_ULP_FIELD_OPC_SRC1,
	.field_src1 = BNXT_ULP_FIELD_SRC_ZERO
	},
	...
	.field_src1 = BNXT_ULP_FIELD_SRC_ACT_BIT,
	.field_opr1 = {
	((uint64_t)BNXT_ULP_ACT_BIT_POP_MPLS >> 56) & 0xff,
	((uint64_t)BNXT_ULP_ACT_BIT_POP_MPLS >> 48) & 0xff,
	((uint64_t)BNXT_ULP_ACT_BIT_POP_MPLS >> 40) & 0xff,
	((uint64_t)BNXT_ULP_ACT_BIT_POP_MPLS >> 32) & 0xff,
	((uint64_t)BNXT_ULP_ACT_BIT_POP_MPLS >> 24) & 0xff,
	((uint64_t)BNXT_ULP_ACT_BIT_POP_MPLS >> 16) & 0xff,
	((uint64_t)BNXT_ULP_ACT_BIT_POP_MPLS >> 8) & 0xff,
	(uint64_t)BNXT_ULP_ACT_BIT_POP_MPLS & 0xff},
	.field_src2 = BNXT_ULP_FIELD_SRC_RF,
	.field_opr2 = {
	...
	.field_src1 = BNXT_ULP_FIELD_SRC_CONST,
	.field_opr1 = {
	ULP_THOR2_SYM_TECT_SMAC_OVR_REUSE_OUTER_SMAC}
	},
	{
	.description = "vlan_ovr",
	.field_bit_size = 3,
	...
	.field_src1 = BNXT_ULP_FIELD_SRC_CONST,
	.field_opr1 = {
	ULP_THOR2_SYM_TECT_DMAC_OVR_REUSE_OUTER_DMAC}
	},
	{
	.description = "gre_set_k",
	.field_bit_size = 1,
	...
	.field_src1 = BNXT_ULP_FIELD_SRC_ACT_PROP,
	.field_opr1 = {
	(BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS0_LABEL >> 8) & 0xff,
	BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS0_LABEL & 0xff}
	},
	{
	.description = "tc_0",
	.field_bit_size = 3,
	...
	.field_src1 = BNXT_ULP_FIELD_SRC_ACT_PROP,
	.field_opr1 = {
	(BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS0_TC >> 8) & 0xff,
	BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS0_TC & 0xff}
	},
	{
	.description = "bos_0",
	.field_bit_size = 1,
	...
	.field_src1 = BNXT_ULP_FIELD_SRC_ACT_PROP,
	.field_opr1 = {
	(BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS0_BOS >> 8) & 0xff,
	BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS0_BOS & 0xff}
	},
	{
	.description = "ttl_0",
	.field_bit_size = 8,
	...
	.field_src1 = BNXT_ULP_FIELD_SRC_ACT_PROP,
	.field_opr1 = {
	(BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS0_TTL >> 8) & 0xff,
	BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS0_TTL & 0xff}
	},
	{
	.description = "label_1",
	.field_bit_size = 20,
	...
	.field_src2 = BNXT_ULP_FIELD_SRC_ACT_PROP,
	.field_opr2 = {
	(BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS1_LABEL >> 8) & 0xff,
	BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS1_LABEL & 0xff},
	.field_src3 = BNXT_ULP_FIELD_SRC_SKIP
	},
	{
	.description = "tc_1",
	...
	.field_src2 = BNXT_ULP_FIELD_SRC_ACT_PROP,
	.field_opr2 = {
	(BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS1_TC >> 8) & 0xff,
	BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS1_TC & 0xff},
	.field_src3 = BNXT_ULP_FIELD_SRC_SKIP
	},
	{
	.description = "bos_1",
	...
	.field_src2 = BNXT_ULP_FIELD_SRC_ACT_PROP,
	.field_opr2 = {
	(BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS1_BOS >> 8) & 0xff,
	BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS1_BOS & 0xff},
	.field_src3 = BNXT_ULP_FIELD_SRC_SKIP
	},
	{
	.description = "ttl_1",
	...
	.field_src2 = BNXT_ULP_FIELD_SRC_ACT_PROP,
	.field_opr2 = {
	(BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS1_TTL >> 8) & 0xff,
	BNXT_ULP_ACT_PROP_IDX_OF_PUSH_MPLS1_TTL & 0xff},
	.field_src3 = BNXT_ULP_FIELD_SRC_SKIP
	},
	/* act_tid: 7, , table: cmm_full_act_record.0 */
	{
	...
	.field_src1 = BNXT_ULP_FIELD_SRC_ACT_BIT,
	.field_opr1 = {
	((uint64_t)BNXT_ULP_ACT_BIT_PUSH_MPLS >> 56) & 0xff,
	((uint64_t)BNXT_ULP_ACT_BIT_PUSH_MPLS >> 48) & 0xff,
	((uint64_t)BNXT_ULP_ACT_BIT_PUSH_MPLS >> 40) & 0xff,
	((uint64_t)BNXT_ULP_ACT_BIT_PUSH_MPLS >> 32) & 0xff,
	((uint64_t)BNXT_ULP_ACT_BIT_PUSH_MPLS >> 24) & 0xff,
	((uint64_t)BNXT_ULP_ACT_BIT_PUSH_MPLS >> 16) & 0xff,
	((uint64_t)BNXT_ULP_ACT_BIT_PUSH_MPLS >> 8) & 0xff,
	(uint64_t)BNXT_ULP_ACT_BIT_PUSH_MPLS & 0xff},
	.field_src2 = BNXT_ULP_FIELD_SRC_CONST,
	.field_opr2 = {
