...
#else
static inline void bnxt_tf_debugfs_create_files(struct bnxt *bp, u8 tsid, struct dentry *port_dir)
{
}
...
#else /* !CONFIG_VF_REPS && !CUSTOM_FLOWER */
static inline bool bnxt_tf_can_enable_vf_trust(struct bnxt *bp)
{
	return 0;
}
...
static inline int bnxt_tf_port_init(struct bnxt *bp, u16 flag)
{
	return 0;
}
...
static inline void bnxt_tf_port_deinit(struct bnxt *bp, u16 flag)
{
}

static inline void bnxt_tf_port_reinit(struct bnxt *bp)
{
}
...
static inline int bnxt_devlink_tf_port_init(struct bnxt *bp)
{
	return 0;
}

static inline void bnxt_devlink_tf_port_deinit(struct bnxt *bp)
{
}
...
static inline void bnxt_tf_force_mirror_en_get(struct bnxt *bp, bool *tf_en,
					       bool *force_mirror_en)
{
}
...
static inline int bnxt_hwrm_release_afm_func(struct bnxt *bp, u16 fid, u16 rfid,
					     u8 type, u32 flags)
{
	return 0;
}
