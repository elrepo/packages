...
const struct bnxt_ulp_generic_tbl_params ulp_wh_plus_generic_tbl_params[] = {
	...
	[BNXT_ULP_RESOURCE_SUB_TYPE_GENERIC_TABLE_UDCC_LAG_QPCTR_CACHE << 1 |
		BNXT_ULP_DIRECTION_INGRESS] = {
	.name = "INGRESS GENERIC_TABLE_UDCC_LAG_QPCTR_CACHE",
	.gen_tbl_type = BNXT_ULP_GEN_TBL_TYPE_KEY_LIST,
	.result_num_entries = 0,
	.result_num_bytes = 0,
	.key_num_bytes = 0,
	...
	[BNXT_ULP_RESOURCE_SUB_TYPE_GENERIC_TABLE_UDCC_LAG_QPCTR_CACHE << 1 |
		BNXT_ULP_DIRECTION_EGRESS] = {
	.name = "EGRESS GENERIC_TABLE_UDCC_LAG_QPCTR_CACHE",
	.gen_tbl_type = BNXT_ULP_GEN_TBL_TYPE_KEY_LIST,
	.result_num_entries = 0,
	.result_num_bytes = 0,
	.key_num_bytes = 0,
