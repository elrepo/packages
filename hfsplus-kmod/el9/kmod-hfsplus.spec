...
%build
%{__make} -C %{kernel_source} %{?_smp_mflags} V=1 modules M=$PWD CONFIG_HFSPLUS_FS=m
...
%changelog
* Thu May 21 2026 Akemi Yagi <toracat@elrepo.org> - 0.8-4
- Rebuilt against RHEL 9.8 GA kernel

* Fri Jan 02 2026 Tuan Hoang <tqhoang@elrepo.org> - 0.8-3
...
* Fri May 03 2024 Akemi Yagi <toracat@elrepo.org> - 0.7-4
- Rebuilt for RHEL 9.4

* Thu Jan 25 2024 Akemi Yagi <toracat@elrepo.org> - 0.7-3
- Rebuilt against kernel-5.14.0-362.18.1.el9_3

* Sat Dec 16 2023 Akemi Yagi <toracat@elrepo.org> - 0.7-2
