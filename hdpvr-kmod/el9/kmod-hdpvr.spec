...
%changelog
* Mon Nov 17 2025 Akemi Yagi <toracat@elrepo.org> - 0.2.1-9
...
* Tue Nov 12 2024 Philip J Perry <phil@elrepo.org> - 0.2.1-6
- Rebuilt for RHEL 9.5
- Source code is has not changed in RHEL 9.5 kernel

* Fri May 03 2024 Tuan Hoang <tqhoang@elrepo.org> - 0.2.1-5
- Rebuilt against 9.4 GA kernel 5.14.0-427.13.1.el9_4
- Source code is has not changed in RHEL 9.4 kernel

* Sat Jan 27 2024 Philip J Perry <phil@elrepo.org> - 0.2.1-4
- Rebuilt against kernel 5.14.0-362.18.1.el9_3

* Tue Nov 07 2023 Philip J Perry <phil@elrepo.org> - 0.2.1-3
- Rebuilt for RHEL 9.3
- Source updated from RHEL 9.3 kernel

* Tue May 09 2023 Akemi Yagi <toracat@elrepo.org> - 0.2.1-2
- Rebuilt against RHEL 9.2 GA kernel 5.14.0-284.11.1.el9_2
- Source code from kernel-5.14.0-284.11.1.el9_2

* Sat Mar 25 2023 Akemi Yagi <toracat@elrepo.org> - 0.2.1-1
