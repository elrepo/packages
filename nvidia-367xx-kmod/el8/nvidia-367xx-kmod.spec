...
%define kmod_name	%{kmod_basename}-367xx

# If kmod_kernel_version isn't defined on the rpmbuild line, define it here.
%{!?kmod_kernel_version: %define kmod_kernel_version 4.18.0-553.144.1.el8_10}
...
# Source code patches
Patch0:		nvidia-367xx-buildfix-el8_10.patch
Patch1:		nvidia-367xx-backport-390xx-uvm.patch
...
Requires:	nvidia-x11-drv-367xx = %{?epoch:%{epoch}:}%{version}
...
%changelog
* Thu Jul 16 2026 Tuan Hoang <tqhoang@elrepo.org> - 367.134-1.2
- Rebuilt against RHEL 8.10 errata kernel 4.18.0-553.144.1.el8_10

* Tue Mar 24 2026 Tuan Hoang <tqhoang@elrepo.org> - 367.134-1.1
- Rebuilt against RHEL 8.10 errata kernel 4.18.0-553.75.1.el8_10

* Tue Mar 24 2026 Tuan Hoang <tqhoang@elrepo.org> - 367.134-1
- Bump for release
- Built against RHEL 8.10 GA kernel 4.18.0-553.el8_10

* Fri Feb 13 2026 Tuan Hoang <tqhoang@elrepo.org> - 367.134-0.1
- Rebuilt against RHEL 8.10 errata kernel 4.18.0-553.75.1.el8_10
