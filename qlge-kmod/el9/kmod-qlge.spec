...
# Patches.
Patch0: 	0001-staging-qlge-Replace-strncpy-with-strscpy.patch
Patch1: 	0002-staging-qlge-Replace-the-occurrences-of-1-x-by-BIT-x.patch
Patch2: 	0003-staging-qlge-Update-TODO.patch
Patch3: 	0004-staging-qlge-devlink-health-use-retained-error-fmsg-.patch
Patch10: 	elrepo-qlge-devlink_health_reporter_create.el9_8.patch
Patch11: 	elrepo-qlge-timer_container_of.el9_8.patch
...
%changelog
* Wed May 20 2026 Tuan Hoang <tqhoang@elrepo.org> - 1.00.00.35-6
- Built against RHEL 9.8 GA kernel-5.14.0-687.5.3.el9_8
- Add devlink_health_reporter_create patch for RHEL 9.8
- Add timer_container_of patch for RHEL 9.8

* Fri Jan 02 2026 Tuan Hoang <tqhoang@elrepo.org> - 1.00.00.35-5
...
* Tue Nov 12 2024 Tuan Hoang <tqhoang@elrepo.org> - 1.00.00.35-2
- Rebuilt against RHEL 9.5 GA kernel

* Wed Oct 23 2024 Tuan Hoang <tqhoang@elrepo.org> - 1.00.00.35-1
- Initial build for RHEL 9.4
- Built against 9.4 GA kernel 5.14.0-427.13.1.el9_4
- Initial patch work from Stefan-Dragos Ipate <ipates@navcanada.ca>
- Rebased source code from kernel 6.6
- Added mainline patches up to commit 88eddb0cce1c654090d94499b7c78085b23b7c2f
  https://github.com/torvalds/linux/commit/88eddb0cce1c654090d94499b7c78085b23b7c2f
- Added linux-next patch for commit 3465915e99858c7070cabde8bc04cbe2e5bb758c
  https://git.kernel.org/pub/scm/linux/kernel/git/next/linux-next.git/commit/drivers/staging?h=stable&id=3465915e99858c7070cabde8bc04cbe2e5bb758c
