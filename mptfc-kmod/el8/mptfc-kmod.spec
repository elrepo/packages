...
%build
%{__make} -C %{kernel_source} %{?_smp_mflags} modules M=$PWD CONFIG_FUSION_FC=m
...
%changelog
* Tue Sep 13 2022 Akemi Yagi <toracat@elrepo.org> - 3.04.20-7
- Rebuilt against RHEL 8.6 kernel

* Sat Nov 13 2021 Akemi Yagi <toracat@elrepo.org> - 3.04.20-6
...
* Thu Sep 19 2019 Akemi Yagi <toracat@elrepo.org> - 3.04.20-1
- Initial release for RHEL 8
