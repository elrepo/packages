...
echo "override %{kmod_name}-%{kmod_ver} * weak-updates/%{kmod_name}" > kmod-%{kmod_name}.conf
...
pushd drivers/net/ovpn-dco/
%{__install} %{kmod_name}-%{kmod_ver}.ko %{buildroot}/lib/modules/%{kmod_kernel_version}.%{_arch}/extra/%{kmod_name}/
popd
