...
# Source code patches.
Patch0: 	0001-eth-mlx4-don-t-try-to-complete-XDP-frames-in-netpoll.patch
Patch1: 	0002-net-mlx4_core-Avoid-impossible-mlx4_db_alloc-order-v.patch
...
- Add patches from upsream linux-6.12.y

* Sat Dec 06 2025 Tuan Hoang <tqhoang@elrepo.org> - 4.0-3
- Fix posttrans bugs
...
* Fri Nov 14 2025 Tuan Hoang <tqhoang@elrepo.org> - 4.0-2
- Source code from RHEL 10.1 GA kernel
- Built against RHEL 10.1 GA kernel-6.12.0-124.8.1.el10_1

* Fri Sep 19 2025 Philip J Perry <phil@elrepo.org> - 4.0-1
- Initial build for RHEL 10.0
  [https://elrepo.org/bugs/view.php?id=1563]
- Source backported from RHEL kernel-6.12.0-55.9.1.el10_0
