...
%{__install} infiniband/%{kmod_name}_ib.ko %{buildroot}/lib/modules/%{kmod_kernel_version}.%{_arch}/extra/%{kmod_name}/
...
* Sat Dec 16 2023 Tuan Hoang <tqhoang@elrepo.org> - 4.0-6
- Rebuilt against RHEL 9.3 errata kernel 5.14.0-362.13.1.el9_3

* Tue Nov 07 2023 Philip J Perry <phil@elrepo.org> - 4.0-5
- Rebuilt for RHEL 9.3
- Source updated from RHEL 9.3 kernel

* Tue May 09 2023 Philip J Perry <phil@elrepo.org> - 4.0-4
- Rebuilt for RHEL 9.2 
- Source updated from RHEL 9.2 kernel

* Tue Nov 15 2022 Philip J Perry <phil@elrepo.org> - 4.0-3
...
* Thu Oct 06 2022 Philip J Perry <phil@elrepo.org> - 4.0-1
- Initial build for RHEL 9
- Backported from RHEL kernel-5.14.0-70.13.1.el9_0 source 
  [https://elrepo.org/bugs/view.php?id=1275]
