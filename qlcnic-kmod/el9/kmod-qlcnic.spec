...
%{__make} -C %{kernel_source} %{?_smp_mflags} V=1 modules M=$PWD M=$PWD \
	CONFIG_QLCNIC=m CONFIG_QLCNIC_SRIOV=y CONFIG_QLCNIC_DCB=y CONFIG_QLCNIC_HWMON=y \
	EXTRA_CFLAGS='-DCONFIG_QLCNIC -DCONFIG_QLCNIC_SRIOV -DCONFIG_QLCNIC_DCB -DCONFIG_QLCNIC_HWMON'
