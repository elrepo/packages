...
%build
%{__make} -C %{kernel_source} %{?_smp_mflags} V=1 modules M=$PWD M=$PWD CONFIG_BE2NET=m
...
%changelog
* Fri May 22 2026 Akemi Yagi <toracat@elrepo.org> - 12.0.0.0-20
- Source code updated from RHEL 9.8 GA kernel
- Built against RHEL 9.8 GA kernel-5.14.0-687.5.3.el9_8

* Fri Jan 02 2026 Tuan Hoang <tqhoang@elrepo.org> - 12.0.0.0-19
- Fix problems in posttrans section
- Fix macro usage in files section
- Fix hard-coded arch in post section

* Tue Nov 18 2025 Akemi Yagi <toracat@elrepo.org> - 12.0.0.0-18
- Rebuilt against RHEL 9.7 GA kernel
- Source code from kernel-5.14.0-611.5.1.el9_7

* Wed May 14 2025 Tuan Hoang <tqhoang@elrepo.org> - 12.0.0.0-17
- Rebuilt against RHEL 9.6 GA kernel
- Source code from kernel-5.14.0-570.12.1.el9_6

* Tue Nov 12 2024 Philip J Perry <phil@elrepo.org> - 12.0.0.0-16
- Rebuilt for RHEL 9.5
- Source updated from RHEL 9.5 GA kernel

* Fri May 03 2024 Akemi Yagi <toracat@elrepo.org> - 12.0.0.0-15
- Rebuilt for RHEL 9.4
- Source updated from RHEL 9.4 GA kernel

* Thu Jan 25 2024 Akemi Yagi <toracat@elrepo.org> - 12.0.0.0-14
- Rebuilt against kernel-5.14.0-362.18.1.el9_3

* Sat Dec 16 2023 Akemi Yagi <toracat@elrepo.org> - 12.0.0.0-13
- Rebuilt against kernel-5.14.0-362.13.1.el9_3

* Tue Nov 07 2023 Philip J Perry <phil@elrepo.org> - 12.0.0.0-12
- Rebuilt for RHEL 9.3
- Source updated from RHEL 9.3 kernel

* Tue May 09 2023 Akemi Yagi <toracat@elrepo.org> - 12.0.0.0-11.el9_2
- Rebuilt against RHEL 9.2 GA kernel 5.14.0-284.11.1.el9_2
- Source code from kernel-5.14.0-284.11.1.el9_2

* Tue Nov 15 2022 Akemi Yagi <toracat@elrepo.org> - 12.0.0.0-10
