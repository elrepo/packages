...
%setup -q -c -T -a 0
%patch0 -p0
%{__cp} -a 2011_0225_RT5370_RT5372_Linux_STA_V2.5.0.1_DPO _kmod_build_
...
%{__install} os/linux/rt5370sta.ko %{buildroot}/lib/modules/%{kversion}/extra/%{kmod_name}/
...
%changelog
* Wed Jul 27 2011 Philip J Perry <phil@elrepo.org> - 2.5.0.1-1.el6.elrepo
