...
URL:	 http://www.ralinktech.com.tw/data/drivers/2011_0225_RT5370_RT5372_Linux_STA_V2.5.0.1_DPO.tar.bz2
...
# Sources.
Source0:  2011_0225_RT5370_RT5372_Linux_STA_V2.5.0.1_DPO.tar.bz2
Source5:  GPL-v2.0.txt
Source10: kmodtool-%{kmod_name}-el5.sh

# Patches.
Patch0: rt5370sta-unspecified-license.patch
...
RaLink RT5370/RT5372 wireless USB series network adapters.
...
%setup -q -c -T -a 0
%patch0 -p0
pushd 2011_0225_RT5370_RT5372_Linux_STA_V2.5.0.1_DPO
...
for kvariant in %{kvariants} ; do
    %{__cp} -a 2011_0225_RT5370_RT5372_Linux_STA_V2.5.0.1_DPO _kmod_build_$kvariant
done
%{__cp} -a %{SOURCE5} .
...
for kvariant in %{kvariants} ; do
    ...
    %{__install} os/linux/rt5370sta.ko %{buildroot}/lib/modules/%{kversion}${kvariant}/extra/%{kmod_name}/
...
%changelog
* Tue May 03 2011 Philip J Perry <phil@elrepo.org> - 2.5.0.1-1.el5.elrepo
- Initial build of the kmod package.
- Fix module license 'unspecified' taints kernel [rt5370sta-unspecified-license.patch]
