...
%build
%{__make} -C %{kernel_source} %{?_smp_mflags} modules M=$PWD CONFIG_SATA_PROMISE=m
...
%changelog
* Fri May 24 2024 Tuan Hoang <tqhoang@elrepo.org> - 2.12-3
- Rebuilt against RHEL 8.10 GA kernel 4.18.0-553.el8_10
- ATA source code is unchanged in 8.10

* Sun Nov 19 2023 Tuan Hoang <tqhoang@elrepo.org> - 2.12-2
- Rebuilt against RHEL 8.9 GA kernel
- Source code from kernel-4.18.0-513.5.1.el8_9

* Wed Oct 18 2023 Akemi Yagi <toracat@elrepo.org> - 2.12-1
- Initial build for RHEL 8 
- Built against RHEL 8.8 GA kernel-4.18.0-477.10.1.el8_8
- Source code from kernel-4.18.0-477.10.1.el8_8
  [https://elrepo.org/bugs/view.php?id=1392]
