...
struct xdma_cdev {
	...
	struct xdma_vme_user_irq *vme_user_irq;	/* VME IRQ value, if needed */
...
struct xdma_pci_dev {
	...
	struct xdma_dev *xdev;
	struct proc_dir_entry *proc_dir; // CAEN A5818
	int major;		/* major number */
	int instance;		/* instance number */
	int user_max;
	int vme_user_max; // CAEN A5818
	int c2h_channel_max;
	int h2c_channel_max;
	...
	struct xdma_cdev vme_events_cdev[32]; // CAEN A5818
