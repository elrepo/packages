...
/* Module Parameters */
unsigned int h2c_timeout = 3;
module_param(h2c_timeout, uint, 0644);
MODULE_PARM_DESC(h2c_timeout, "H2C sgdma timeout in seconds, default is 3 sec.");

unsigned int c2h_timeout = 3;
module_param(c2h_timeout, uint, 0644);
MODULE_PARM_DESC(c2h_timeout, "C2H sgdma timeout in seconds, default is 3 sec.");
