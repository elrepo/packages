...
# Sources.
Source0:	a5818_linux_driver-v%{version}.tar.gz
...
%prep
%setup -q -n a5818_linux_driver-v%{version}
echo "override %{kmod_name} * weak-updates/%{kmod_name}" > kmod-%{kmod_name}.conf

# Apply patch(es)

%build
%{__make} -C %{kernel_source} %{?_smp_mflags} V=1 modules M=$PWD/xdma
...
%{__install} xdma/%{kmod_name}.ko %{buildroot}/lib/modules/%{kmod_kernel_version}.%{_arch}/extra/%{kmod_name}/
...
%changelog
* Sat May 23 2026 Tuan Hoang <tqhoang@elrepo.org> - 1.0.6-1
- Update to version 1.0.6

* Sat May 23 2026 Akemi Yagi <toracat@elrepo.org> - 1.0.5-4
- Rebuilt against RHEL 9.8 GA kernel-5.14.0-687.5.3.el9_8

* Fri Jan 02 2026 Tuan Hoang <tqhoang@elrepo.org> - 1.0.5-3
- Fix problems in posttrans section
- Fix macro usage in files section
- Fix hard-coded arch in post section

* Mon Nov 17 2025 Akemi Yagi <toracat@elrepo.org> - 1.0.5-2
- Rebuilt against RHEL 9.7 GA kernel 5.14.0-611.5.1.el9_7

* Fri Aug 15 2025 Akemi Yagi <toracat@elrepo.org> - 1.0.5
- Initial build for RHEL 9.6
- Built against RHEL 9.6 GA kernel 5.14.0-570.12.1.el9_6
- Source code submitted by jcpunk
  [https://elrepo.org/bugs/view.php?id=1554]
