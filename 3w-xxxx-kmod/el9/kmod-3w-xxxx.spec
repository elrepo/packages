...
%changelog
* Thu May 21 2026 Akemi Yagi <toracat@elrepo.org> - 1.26.02.003-11
- Rebuilt against RHEL 9.8 GA kernel

* Fri Jan 02 2026 Tuan Hoang <tqhoang@elrepo.org> - 1.26.02.003-10
- Fix problems in posttrans section
- Fix macro usage in files section

* Mon Nov 17 2025 Tuan Hoang <tqhoang@elrepo.org> - 1.26.02.003-9
- Rebuilt against RHEL 9.7 GA kernel
- Source code updated from 9.7 GA kernel
- Fix hard-coded arch in post section

* Wed May 14 2025 Tuan Hoang <tqhoang@elrepo.org> - 1.26.02.003-8
- Rebuilt against RHEL 9.6 GA kernel

* Tue Nov 12 2024 Tuan Hoang <tqhoang@elrepo.org> - 1.26.02.003-7
- Rebuilt against RHEL 9.5 GA kernel

* Thu May 02 2024 Akemi Yagi <toracat@elrepo.org> - 1.26.02.003-6
- Rebuilt for RHEL 9.4

* Sat Dec 16 2023 Tuan Hoang <tqhoang@elrepo.org> - 1.26.02.003-5
- Rebuilt against RHEL 9.3 errata kernel 5.14.0-362.13.1.el9_3

* Tue Nov 07 2023 Philip J Perry <phil@elrepo.org> - 1.26.02.003-4
- Rebuilt for RHEL 9.3

* Tue May 09 2023 Philip J Perry <phil@elrepo.org> - 1.26.02.003-3
- Rebuilt for RHEL 9.2

* Tue Nov 15 2022 Philip J Perry <phil@elrepo.org> - 1.26.02.003-2
- Rebuilt for RHEL 9.1

* Mon May 09 2022 Philip J Perry <phil@elrepo.org> - 1.26.02.003-1
