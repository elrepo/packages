...
%changelog
* Thu May 23 2024 Akemi Yagi <toracat@elrepo.org> - 0.0-2
- Rebuilt against RHEL 8.10 GA kernel-4.18.0-553.el8_10

* Sat Nov 18 2023 Philip J Perry <phil@elrepo.org> 0.0-1
- Initial commit, built for RHEL 8.9
  [https://elrepo.org/bugs/view.php?id=1405]
- Backported from kernel-5.10.200
