...
echo "override mt76 * weak-updates/%{kmod_name}" >> kmod-%{kmod_name}.config
echo "override mt76-connac-lib * weak-updates/%{kmod_name}" >> kmod-%{kmod_name}.config
echo "override mt7921e * weak-updates/%{kmod_name}" > kmod-%{kmod_name}.conf
echo "override mt7921-common * weak-updates/%{kmod_name}" >> kmod-%{kmod_name}.config
%build
...
%{__install} mt76.ko %{buildroot}/lib/modules/%{kmod_kernel_version}.%{_arch}/extra/%{kmod_name}/
%{__install} mt76-connac-lib.ko %{buildroot}/lib/modules/%{kmod_kernel_version}.%{_arch}/extra/%{kmod_name}/
%{__install} mt7921/mt7921e.ko %{buildroot}/lib/modules/%{kmod_kernel_version}.%{_arch}/extra/%{kmod_name}/
%{__install} mt7921/mt7921-common.ko %{buildroot}/lib/modules/%{kmod_kernel_version}.%{_arch}/extra/%{kmod_name}/
...
%changelog
* Sat Sep 17 2022 Philip J Perry <phil@elrepo.org> - 0.0-2
- Updated to kernel-5.18.19

* Sat Sep 17 2022 Philip J Perry <phil@elrepo.org> - 0.0-1
- Initial build for RHEL 9 [https://elrepo.org/bugs/view.php?id=1265]
- Backported from kernel-5.16.20
