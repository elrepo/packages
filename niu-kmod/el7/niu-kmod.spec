...
%changelog
* Tue Apr 10 2018 Philip J Perry <phil@elrepo.org> - 1.1-2
- Rebuilt against RHEL 7.5 kernel
- Apply patch

* Thu Nov 23 2017 Philip J Perry <phil@elrepo.org> - 1.1-1
- Initial el7 build of the kmod package.
- Backported from kernel-3.10.108
