...
%changelog
* Fri May 22 2026 Akemi Yagi <toracat@elrepo.org> - 1.15-12
- Rebuilt against RHEL 9.8 GA kernel

* Fri Jan 02 2026 Tuan Hoang <tqhoang@elrepo.org> - 1.15-11
- Fix problems in posttrans section
- Fix macro usage in files section
- Fix hard-coded arch in post section

* Mon Nov 17 2025 Akemi Yagi <toracat@elrepo.org> - 1.15-10
- Rebuilt against RHEL 9.7 GA kernel 5.14.0-611.5.1.el9_7

* Wed May 14 2025 Akemi Yagi <toracat@elrepo.org> - 1.15-9
- Rebuilt for RHEL 9.6

* Tue Nov 12 2024 Philip J Perry <phil@elrepo.org> - 1.15-8
- Rebuilt for RHEL 9.5

* Fri May 03 2024 Akemi Yagi <toracat@elrepo.org> - 1.15-7
- Rebuilt for RHEL 9.4

* Fri Jan 26 2024 Tuan Hoang <tqhoang@elrepo.org> - 1.15-6
- Rebuilt against RHEL 9.3 errata kernel 5.14.0-362.18.1.el9_3

* Sat Dec 16 2023 Tuan Hoang <tqhoang@elrepo.org> - 1.15-5
- Rebuilt against RHEL 9.3 errata kernel 5.14.0-362.13.1.el9_3

* Tue Nov 07 2023 Philip J Perry <phil@elrepo.org> - 1.15-4
- Rebuilt for RHEL 9.3

* Tue May 09 2023 Philip J Perry <phil@elrepo.org> - 1.15-3
...
- Initial build for RHEL 9
  [https://elrepo.org/bugs/view.php?id=1285]
