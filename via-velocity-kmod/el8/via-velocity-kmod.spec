...
# Source code patches.
Patch0: 	elrepo-via-velocity-netif_napi_add.el8_10.patch
...
%{__make} -C %{kernel_source} %{?_smp_mflags} modules M=$PWD \
	...
	EXTRA_CFLAGS='-DCONFIG_VIA_VELOCITY'
...
%changelog
* Thu Apr 23 2026 Tuan Hoang <tqhoang@elrepo.org> 1.15-1
- Initial el8 build of the kmod package.
  [https://elrepo.org/bugs/view.php?id=1590]
