...
RaLink RT2870/RT2770 wireless USB series network adapters.
It is built to depend upon the specific ABI provided by a range of releases
of the same variant of the Linux kernel and not on any one specific build.

%prep
%setup -q -c -T -a 0
%{__cp} -a 2010_0709_RT2870_Linux_STA_v2.4.0.1 _kmod_build_
...
%{__install} os/linux/rt2870sta.ko %{buildroot}/lib/modules/%{kversion}/extra/%{kmod_name}/
...
%changelog
* Thu Mar 17 2011 Philip J Perry <phil@elrepo.org> - 2.4.0.1-1.el6.elrepo
