...
Source1		    http://www.openafs.org/dl/openafs/%{version}/%{name}-%{version}%{?pre}-doc.tar.bz2
Source11:        CellServDB
Source12:        cacheinfo
...
* Fri Mar 23 2012 Jack Neely <jjneely@ncsu.edu> 0:1.6.1-0.pre1.2
- Require(post) the restorecon binary for openafs-client
- Patch from Ken Dreyer

* Mon Mar 12 2012 Jack Neely <jjneely@ncsu.edu> 0:1.6.1-0.pre1.2
...
- Buitd openafs  1.6.1pre2 or what I really hope will be released as pre2
  in a few days
