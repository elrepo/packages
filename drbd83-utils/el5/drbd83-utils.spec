...
Source: http://oss.linbit.com/drbd/8.3/drbd-%{version}.tar.gz
...
* Mon Aug 08 2011 Dag Wieers <dag@elrepo.org> - 8.3.11-1
...
* Tue Jun 15 2010 Dag Wieers <dag@elrepo.org> - 8.3.8-3
- Added rgmanager scripts (not enabled by default). (Joseph L. Casale)

* Tue Jun 15 2010 Dag Wieers <dag@elrepo.org> - 8.3.8-2
