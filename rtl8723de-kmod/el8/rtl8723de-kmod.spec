...
License:	GPLv2
URL:		https://github.com/lwfinger/rtlwifi_new/archive/extended.zip
...
echo "override phydm_mod * weak-updates/%{kmod_name}" >> kmod-%{kmod_name}.conf
...
%{__install} %{kmod_name}/%{kmod_name}.ko %{buildroot}/lib/modules/%{kmod_kernel_version}.%{_arch}/extra/%{kmod_name}/
%{__install} rtlwifi.ko %{buildroot}/lib/modules/%{kmod_kernel_version}.%{_arch}/extra/%{kmod_name}/
%{__install} rtl_pci.ko %{buildroot}/lib/modules/%{kmod_kernel_version}.%{_arch}/extra/%{kmod_name}/
%{__install} btcoexist/btcoexist.ko %{buildroot}/lib/modules/%{kmod_kernel_version}.%{_arch}/extra/%{kmod_name}/
%{__install} rtl8723com/rtl8723-common.ko %{buildroot}/lib/modules/%{kmod_kernel_version}.%{_arch}/extra/%{kmod_name}/
%{__install} phydm/phydm_mod.ko %{buildroot}/lib/modules/%{kmod_kernel_version}.%{_arch}/extra/%{kmod_name}/
...
%changelog
* Fri Oct 23 2020 Akemi Yagi <toracat@elrepo.org> 0.0-2
- Rebuilt against RHEL 8.2 kernel

* Sat Dec 21 2019 Akemi Yagi <toracat@elrepo.org> 0.0-1
