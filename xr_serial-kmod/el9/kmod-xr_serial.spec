...
%changelog
* Fri May 22 2026 Akemi Yagi <toracat@elrepo.org> - 0.0-9
- Rebuilt against RHEL 9.8 GA kernel

* Fri Jan 02 2026 Tuan Hoang <tqhoang@elrepo.org> - 0.0-8
- Fix problems in posttrans section
- Fix macro usage in files section
- Fix hard-coded arch in post section

* Tue Nov 18 2025 Akemi Yagi <toracat@elrepo.org> - 0.0-7
- Rebuilt against RHEL 9.7 GA kernel

* Wed May 14 2025 Tuan Hoang <tqhoang@elrepo.org> - 0.0-6
- Rebuilt against RHEL 9.6 GA kernel
- Source code from kernel-5.14.0-570.12.1.el9_6

* Tue Nov 12 2024 Tuan Hoang <tqhoang@elrepo.org> - 0.0-5
...
* Fri Jan 26 2024 Tuan Hoang <tqhoang@elrepo.org> - 0.0-3
- Rebuilt against RHEL 9.3 errata kernel 5.14.0-362.18.1.el9_3

* Tue Nov 07 2023 Philip J Perry <phil@elrepo.org> - 0.0-2
- Rebuilt for RHEL 9.3
- Source updated from RHEL 9.3 kernel

* Wed Oct 25 2023 Akemi Yagi <toracat@elrepo.org> - 0.0-1
- Initial el9 build of the kmod package.
- Built against RHEL 9.2 GA kernel 5.14.0-284.11.1.el9_2
