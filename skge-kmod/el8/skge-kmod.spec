...
# Source code patches
Patch0:		elrepo-skge-extend-coalesce.el8.6.patch
Patch1:		elrepo-skge-extend-ringparam.el8.7.patch
Patch2:		elrepo-skge-netif-napi-add.el8_9.patch
...
* Tue May 18 2021 Philip J Perry <phil@elrepo.org> 1.14-2
- Rebuilt for RHEL8.4
