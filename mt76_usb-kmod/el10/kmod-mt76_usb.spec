...
for modules in mt792x-usb mt7921u mt7925u ; do
...
%{__install} mt792x-usb.ko mt7921/mt7921u.ko mt7925/mt7925u.ko %{buildroot}/lib/modules/%{kmod_kernel_version}.%{_arch}/extra/%{kmod_name}/
