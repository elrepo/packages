...
%changelog
* Fri May 24 2024 Tuan Hoang <tqhoang@elrepo.org> - 1.0-13
- Rebuilt against RHEL 8.10 GA kernel 4.18.0-553.el8_10
- ATA source code is unchanged in 8.10

* Sun Nov 19 2023 Tuan Hoang <tqhoang@elrepo.org> - 1.0-12
...
* Tue Nov 08 2022 Akemi Yagi <toracat@elrepo.org> - 1.0-8
- Source code from kernel-4.18.0-425.3.1.el8 (8.7 GA)
- Built against RHEL 8.7 GA kernel

* Tue May 10 2022 Akemi Yagi <toracat@elrepo.org> - 1.0-7
...
* Tue May 18 2021 Philip J Perry <phil@elrepo.org> - 1.0-6
...
* Tue Apr 28 2020 Akemi Yagi <toracat@elrepo.org> - 1.0-3
- Rebuilt against RHEL 8.2 kernel
- Source code from kernel-4.18.0-193

* Fri Nov 08 2019 Akemi Yagi <toracat@elrepo.org> - 1.0-2
- Rebuilt agains RHEL 8.1 kernel
- Source code from kernel-4.18.0-147

* Tue Sep 24 2019 Elia Devito <eliadevito@gmail.com> - 1.0-1
