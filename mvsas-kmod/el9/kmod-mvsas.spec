...
%changelog
* Wed May 20 2026 Tuan Hoang <tqhoang@elrepo.org> - 0.8.16-12
- Source code updated from RHEL 9.8 GA kernel
- Built against RHEL 9.8 GA kernel-5.14.0-687.5.3.el9_8

* Fri Jan 02 2026 Tuan Hoang <tqhoang@elrepo.org> - 0.8.16-11
- Fix problems in posttrans section
- Fix macro usage in files section

* Mon Nov 17 2025 Tuan Hoang <tqhoang@elrepo.org> - 0.8.16-10
...
* Fri May 03 2024 Akemi Yagi <toracat@elrepo.org> - 0.8.16-7
- Rebuilt for RHEL 9.4

* Sat Jan 27 2024 Philip J Perry <phil@elrepo.org> - 0.8.16-6
- Rebuilt against kernel 5.14.0-362.18.1.el9_3

* Sat Dec 16 2023 Tuan Hoang <tqhoang@elrepo.org> - 0.8.16-5
...
* Tue Nov 15 2022 Philip J Perry <phil@elrepo.org> - 0.8.16-2
- Rebuilt for RHEL 9.1

* Mon May 09 2022 Philip J Perry <phil@elrepo.org> - 0.8.16-1
