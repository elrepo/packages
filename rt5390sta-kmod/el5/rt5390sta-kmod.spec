...
%prep
%setup -q -c -T -a 0
pushd 2010_1216_RT5390_LinuxSTA_V2.4.0.4_WiFiBTCombo_DPO
%{__perl} -pi -e 's|(.*tftpboot$)|#$1|g' Makefile
popd
for kvariant in %{kvariants} ; do
    %{__cp} -a 2010_1216_RT5390_LinuxSTA_V2.4.0.4_WiFiBTCombo_DPO _kmod_build_$kvariant
done
%{__cp} -a %{SOURCE5} .
...
for kvariant in %{kvariants} ; do
    ...
    %{__install} os/linux/rt5390sta.ko %{buildroot}/lib/modules/%{kversion}${kvariant}/extra/%{kmod_name}/
...
%changelog
* Tue May 03 2011 Philip J Perry <phil@elrepo.org> - 2.4.0.4-1.el5.elrepo
