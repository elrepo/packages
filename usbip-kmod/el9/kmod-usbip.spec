...
* Thu Jan 25 2024 Akemi Yagi <toracat@elrepo.org> - 0.0-6
- Rebuilt against kernel-5.14.0-362.18.1.el9_3

* Sat Dec 16 2023 Akemi Yagi <toracat@elrepo.org> - 0.0-5
- Rebuilt against kernel-5.14.0-362.13.1.el9_3

* Tue Nov 07 2023 Philip J Perry <phil@elrepo.org> - 0.0-4
- Rebuilt for RHEL 9.3
- Source updated from RHEL 9.3 kernel

* Tue May 09 2023 Philip J Perry <phil@elrepo.org> - 0.0-3
- Rebuilt for RHEL 9.2 
- Source updated from RHEL 9.2 kernel

* Wed Mar 29 2023 Philip J Perry <phil@elrepo.org> - 0.0-2
...
- Backported from RHEL 9.1 kernel-5.14.0-162.6.1.el9_1
- Disable usbip-vudc module, (depends on USB_GADGET)
