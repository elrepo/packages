...
# Source code patches
Patch0:	elrepo-ath5k-revert-convert-tasklets.8.4.patch
...
%{__install} ath.ko %{buildroot}/lib/modules/%{kmod_kernel_version}.%{_arch}/extra/%{kmod_name}/
...
* Fri Oct 11 2019 Philip J Perry <phil@elrepo.org> 0.0-1
- Initial el8 build of the kmod package.
- Backported from kernel-4.18.20
  [https://elrepo.org/bugs/view.php?id=955]
