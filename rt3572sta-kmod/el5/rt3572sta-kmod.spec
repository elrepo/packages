...
URL:	 http://www.ralinktech.com.tw/data/drivers/2011_0427_RT3572_Linux_STA_v2.5.0.0.DPO.tar.bz2
...
# Sources.
Source0:  2011_0427_RT3572_Linux_STA_v2.5.0.0.DPO.tar.bz2
...
RaLink RT3572 USB wireless series network adapters.
It is built to depend upon the specific ABI provided by a range of releases
of the same variant of the Linux kernel and not on any one specific build.

%prep
%setup -q -c -T -a 0
pushd 2011_0427_RT3572_Linux_STA_v2.5.0.0.DPO
...
for kvariant in %{kvariants} ; do
    %{__cp} -a 2011_0427_RT3572_Linux_STA_v2.5.0.0.DPO _kmod_build_$kvariant
done
%{__cp} -a %{SOURCE5} .
...
for kvariant in %{kvariants} ; do
    ...
    %{__install} os/linux/rt3572sta.ko %{buildroot}/lib/modules/%{kversion}${kvariant}/extra/%{kmod_name}/
...
%changelog
* Mon May 02 2011 Philip J Perry <phil@elrepo.org> - 2.5.0.0-1.el5.elrepo
