...
%prep
%setup -q -c -T -a 0
%{__cp} -a DPO_RT3562_3592_3062_LinuxSTA_V2.4.1.1_20101217 _kmod_build_
...
%{__install} os/linux/rt3562sta.ko %{buildroot}/lib/modules/%{kversion}/extra/%{kmod_name}/
...
%changelog
* Wed Jul 27 2011 Philip J Perry <phil@elrepo.org> - 2.4.1.1-1.el6.elrepo
