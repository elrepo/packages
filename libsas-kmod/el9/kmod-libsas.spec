...
%changelog
* Thu Jun 04 2026 Tuan Hoang <tqhoang@elrepo.org> - 0.0-4
- Rebuilt against RHEL 9.8 GA kernel-5.14.0-687.5.3.el9_8
- Source code from 9.8 GA kernel-5.14.0-687.5.3.el9_8

* Fri Jan 02 2026 Tuan Hoang <tqhoang@elrepo.org> - 0.0-3
- Fix problems in posttrans section
- Fix macro usage in files section

* Mon Nov 17 2025 Tuan Hoang <tqhoang@elrepo.org> - 0.0-2
...
- Source code from RHEL 9.6 GA kernel
