...
%build
%{__make} -C %{kernel_source} %{?_smp_mflags} V=1 modules M=$PWD CONFIG_PATA_VIA=m
...
%changelog
* Wed May 20 2026 Tuan Hoang <tqhoang@elrepo.org> - 0.3.4-11
