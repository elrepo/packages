...
%build
%{__make} -C %{kernel_source} %{?_smp_mflags} modules M=$PWD CONFIG_LRU_CACHE=m
...
%changelog
* Thu May 23 2024 Akemi Yagi <toracat@elrepo.org> - 0.0-4
...
* Fri Nov 17 2023 Akemi Yagi <toracat@elrepo.org> - 0.0-1
- Initial build for RHEL 8.8
- Source from RHEL 8.8 kernel-4.18.0-477.21.1.el8_8
  [https://elrepo.org/bugs/view.php?id=1406]
