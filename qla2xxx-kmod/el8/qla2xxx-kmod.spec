...
%changelog
* Thu Sep 24 2026 Tuan Hoang <tqhoang@elrepo.org> - 10.02.09.100-7
- Source code updated from RHEL kernel-4.18.0-553.168.1.el8_10.x86_64
...
* Tue Nov 08 2022 Philip J Perry <phil@elrepo.org> 10.02.07.400-1
- Rebuilt for RHEL 8.7
- Source code updated from RHEL kernel-4.18.0-425.3.1.el8

* Tue May 10 2022 Philip J Perry <phil@elrepo.org> 10.02.06.200-1
- Rebuilt for RHEL 8.6
- Source code updated from RHEL kernel-4.18.0-372.9.1.el8.x86_64

* Sat Nov 13 2021 Philip J Perry <phil@elrepo.org> 10.02.00.106-1
- Rebuilt for RHEL8.5
...
- Backported from RHEL-8.2 kernel-4.18.0-193.el8
- Revert removal of PCI_DEVICE_IDs for older devices
  [https://github.com/elrepo/packages/commit/1ef89751cfe949dc5a8947c7e4c42d6dc5c3a7a1]
