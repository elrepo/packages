...
License:	HighPoint
URL:		https://www.highpoint-tech.com/
...
%prep
%setup -q -c
sh rr64xl-linux-src-v%{version}_%{extid}.bin --tar -xf
echo "override rr640l * weak-updates/%{kmod_name}" > kmod-%{kmod_name}.conf
...
%{__make} %{?_smp_mflags} V=1 KERNELDIR=%{kernel_source}
popd >/dev/null
...
%{__install} product/%{kmod_name}/linux/rr640l.ko %{buildroot}/lib/modules/%{kmod_kernel_version}.%{_arch}/extra/%{kmod_name}/
...
* Mon Nov 17 2025 Tuan Hoang <tqhoang@elrepo.org> - 1.5.8-4
...
* Fri May 03 2024 Tuan Hoang <tqhoang@elrepo.org> - 1.5.8-1
- Update version to 1.5.8
- Add blkdev_get_by_dev patch for RHEL 9.4
- Rebuilt against RHEL 9.4 GA kernel

* Sat Dec 16 2023 Tuan Hoang <tqhoang@elrepo.org> - 1.5.6-5
