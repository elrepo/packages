...
%build
%{__make} -C %{kernel_source} %{?_smp_mflags} modules M=$PWD CONFIG_PATA_ATIIXP=m
...
%changelog
* Fri May 24 2024 Tuan Hoang <tqhoang@elrepo.org> - 0.4.6-6
- Rebuilt against RHEL 8.10 GA kernel 4.18.0-553.el8_10
- ATA source code is unchanged in 8.10

* Sun Nov 19 2023 Tuan Hoang <tqhoang@elrepo.org> - 0.4.6-5
- Rebuilt against RHEL 8.9 GA kernel
- Source code from kernel-4.18.0-513.5.1.el8_9

* Sat Aug 05 2023 Philip J Perry <phil@elrepo.org> - 0.4.6-4
- Rebuilt against RHEL 8.8 GA kernel
  [https://elrepo.org/bugs/view.php?id=1377]
- Source code from kernel-4.18.0-477.10.1

* Tue May 10 2022 Akemi Yagi <toracat@elrepo.org> - 0.4.6-3
...
* Tue May 18 2021 Philip J Perry <phil@elrepo.org> - 0.4.6-2
...
* Thu Feb 18 2021 Akemi Yagi <toracat@elrepo.org> - 0.4.6-1
