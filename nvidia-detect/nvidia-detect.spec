...
- Add support for detection of devices added to 595.91.07 driver release

* Mon Jun 29 2026 Tuan Hoang <tqhoang@elrepo.org> - 580.173.02-1
- Add support for detection of devices added to 580.173.02 driver release

* Wed May 20 2026 Tuan Hoang <tqhoang@elrepo.org> - 580.159.04-1
- Add support for detection of devices added to 580.159.04 driver release

* Tue Apr 28 2026 Tuan Hoang <tqhoang@elrepo.org> - 580.159.03-1
- Add support for detection of devices added to 580.159.03 driver release

* Sun Mar 15 2026 Tuan Hoang <tqhoang@elrepo.org> - 580.142-1
- Add support for detection of devices added to 580.142 driver release

* Thu Jan 15 2026 Tuan Hoang <tqhoang@elrepo.org> - 580.126.09-1
- Add support for detection of devices added to 580.126.09 driver release

* Fri Dec 12 2025 Tuan Hoang <tqhoang@elrepo.org> - 580.119.02-1
- Add support for detection of devices added to 580.119.02 driver release

* Fri Nov 07 2025 Tuan Hoang <tqhoang@elrepo.org> - 580.105.08-1
- Add support for detection of devices added to 580.105.08 driver release

* Thu Oct 02 2025 Tuan Hoang <tqhoang@elrepo.org> - 580.95.05-1
- Add support for detection of devices added to 580.95.05 driver release

* Wed Sep 03 2025 Tuan Hoang <tqhoang@elrepo.org> - 580.82.07-1
- Add support for detection of devices added to 580.82.07 driver release
