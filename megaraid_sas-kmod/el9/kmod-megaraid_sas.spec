...
%{__make} -C %{kernel_source} %{?_smp_mflags} V=1 modules M=$PWD \
	...
	EXTRA_CFLAGS='-DCONFIG_MEGARAID_SAS'
...
%changelog
* Wed May 20 2026 Tuan Hoang <tqhoang@elrepo.org> - 07.734.00.00-3
- Source code updated from RHEL 9.8 GA kernel
- Built against RHEL 9.8 GA kernel-5.14.0-687.5.3.el9_8

* Fri Jan 02 2026 Tuan Hoang <tqhoang@elrepo.org> - 07.734.00.00-2
- Fix problems in posttrans section
- Fix macro usage in files section

* Mon Nov 17 2025 Tuan Hoang <tqhoang@elrepo.org> - 07.734.00.00-1
...
* Wed May 01 2024 Tuan Hoang <tqhoang@elrepo.org> - 07.727.03.00-1
- Rebuilt for RHEL 9.4
- Source updated from RHEL 9.4 GA kernel
- Note: RHEL differences patch no longer applicable

* Sat Jan 27 2024 Philip J Perry <phil@elrepo.org> - 07.725.01.00-3
- Rebuilt against kernel 5.14.0-362.18.1.el9_3

* Sat Dec 16 2023 Tuan Hoang <tqhoang@elrepo.org> - 07.725.01.00-2
