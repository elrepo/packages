...
# Source code patches
# Patch0:	elrepo-arcmsr-scsi_partsize.8.4.patch
...
%changelog
* Fri Mar 28 2025 Tuan Hoang <tqhoang@elrepo.org> - 1.50.00.02-20200819.5
- Rebuilt against RHEL 8.10 errata kernel 4.18.0-553.45.1.el8_10

* Fri May 24 2024 Tuan Hoang <tqhoang@elrepo.org> - 1.50.00.02-20200819.4
- Rebuilt against RHEL 8.10 GA kernel 4.18.0-553.el8_10

* Tue Nov 14 2023 Philip J Perry <phil@elrepo.org> 1.50.00.02-20200819.3
- Rebuilt for RHEL 8.9
- Rebase to kernel-5.10.200

* Tue May 10 2022 Philip J Perry <phil@elrepo.org> 1.50.00.02-20200819.2
- Rebuilt for RHEL 8.6

* Thu Feb 24 2022 Philip J Perry <phil@elrepo.org> - 1.50.00.02-20200819.1
- Rebase to kernel-5.10.102
  [https://elrepo.org/bugs/view.php?id=1204]

* Sat Nov 13 2021 Philip J Perry <phil@elrepo.org> - 1.40.00.05-20180309.6
- Rebuilt for RHEL 8.5 kernel
- Fix SB-signing issue caused by /usr/lib/rpm/brp-strip
  [https://bugzilla.redhat.com/show_bug.cgi?id=1967291]
- Update stripping of modules

* Tue May 18 2021 Philip J Perry <phil@elrepo.org> - 1.40.00.05-20180309.5
- Rebuilt against RHEL 8.4 kernel
- Fix build issues on RHEL 8.4
- Fix updating of initramfs image
  [https://elrepo.org/bugs/view.php?id=1060]
- Revert addition of dracut conf file

* Wed Nov 04 2020 Philip J Perry <phil@elrepo.org> 1.40.00.05-20180309.4
- Add dracut conf file to ensure module is in initramfs
- Rebuilt for RHEL8.3

* Tue Apr 28 2020 Philip J Perry <phil@elrepo.org> 1.40.00.05-20180309.3
- Rebuilt for RHEL8.2
