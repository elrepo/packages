...
%define kmod_name	xt_time

# If kmod_kernel_version isn't defined on the rpmbuild line, define it here.
%{!?kmod_kernel_version: %define kmod_kernel_version 5.14.0-687.51.1.el9_8}
...
%changelog
* Thu Sep 24 2026 Tuan Hoang <tqhoang@elrepo.org> - 0.0-10.1
- Rebuilt against RHEL 9.8 errata kernel 5.14.0-687.51.1.el9_8

* Fri May 22 2026 Akemi Yagi <toracat@elrepo.org> - 0.0-10
- Rebuilt against RHEL 9.8 GA kernel

* Fri Jan 02 2026 Tuan Hoang <tqhoang@elrepo.org> - 0.0-9
- Fix problems in posttrans section
- Fix macro usage in files section
- Fix hard-coded arch in post section

* Tue Nov 18 2025 Akemi Yagi <toracat@elrepo.org> - 0.0-8
- Rebuilt against RHEL 9.7 GA kernel

* Wed May 14 2025 Tuan Hoang <tqhoang@elrepo.org> - 0.0-7
- Rebuilt against RHEL 9.6 GA kernel
- Source code from kernel-5.14.0-570.12.1.el9_6

* Tue Nov 12 2024 Tuan Hoang <tqhoang@elrepo.org> - 0.0-6
...
* Tue Nov 07 2023 Philip J Perry <phil@elrepo.org> - 0.0-3
