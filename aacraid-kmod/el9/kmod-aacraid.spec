...
* Sat Dec 16 2023 Tuan Hoang <tqhoang@elrepo.org> - 1.2.1-6
- Rebuilt against RHEL 9.3 errata kernel 5.14.0-362.13.1.el9_3

* Tue Nov 07 2023 Philip J Perry <phil@elrepo.org> - 1.2.1-5
- Rebuilt for RHEL 9.3
- Source updated from RHEL 9.3 kernel

* Tue May 09 2023 Philip J Perry <phil@elrepo.org> - 1.2.1-4
- Rebuilt for RHEL 9.2 
- Source updated from RHEL 9.2 kernel

* Wed Mar 29 2023 Philip J Perry <phil@elrepo.org> - 1.2.1-3
- Rebuilt against kernel 5.14.0-162.22.2.el9_1

* Tue Nov 15 2022 Philip J Perry <phil@elrepo.org> - 1.2.1-2
- Rebuilt for RHEL 9.1
- Source updated from RHEL 9.1 kernel

* Tue May 17 2022 Philip J Perry <phil@elrepo.org> - 1.2.1-1
