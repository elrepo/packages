...
%build
%{__make} -C %{kernel_source} %{?_smp_mflags} V=1 modules M=$PWD CONFIG_ECRYPT_FS=m
...
%changelog
* Thu May 21 2026 Akemi Yagi <toracat@elrepo.org> - 0.3-4
...
* Tue May 13 2025 Akemi Yagi <toracat@elrepo.org> - 0.3-1
- Built against RHEL 9.6 GA kernel 5.14.0-570.12.1.el9_6
- Source updated from RHEL 9.6 kernel

* Tue Nov 12 2024 Akemi Yagi <toracat@elrepo.org> - 0.2-8
- Rebuilt for RHEL 9.5

* Fri May 03 2024 Akemi Yagi <toracat@elrepo.org> - 0.2-7
- Rebuilt for RHEL 9.4

* Thu Jan 25 2024 Akemi Yagi <toracat@elrepo.org> - 0.2-6
- Rebuilt against kernel-5.14.0-362.18.1.el9_3

* Sat Dec 16 2023 Akemi Yagi <toracat@elrepo.org> - 0.2-5
