...
%build
%{__make} -C %{kernel_source} %{?_smp_mflags} modules M=$PWD CONFIG_PATA_SIS=m
...
* Tue May 18 2021 Philip J Perry <phil@elrepo.org> - 0.5.2-5
...
* Fri Nov 06 2020 Akemi Yagi <toracat@elrepo.org> - 0.5.2-4
- Add dracut conf file to ensure module is in initramfs
- Rebuilt against RHEL 8.3 kernel
- Source code from kernel-4.18.0-240

* Tue Apr 28 2020 Akemi Yagi <toracat@elrepo.org> - 0.5.2-3
- Rebuilt against RHEL 8.2 kernel
- Source code from kernel-4.18.0-193

* Fri Nov 08 2019 Akemi Yagi <toracat@elrepo.org> - 0.5.2-2
- Rebuilt agains RHEL 8.1 kernel
- Source code from kernel-4.18.0-147

* Tue Sep 24 2019 Elia Devito <eliadevito@gmail.com> - 0.5.2-1
- Restore the sata_sis kernel module for centos 8
