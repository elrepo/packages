...
%build
%{__make} -C %{kernel_source} %{?_smp_mflags} modules M=$PWD CONFIG_SATA_ULI=m
...
* Tue May 18 2021 Philip J Perry <phil@elrepo.org> - 1.3-4
...
* Thu Nov 05 2020 Akemi Yagi <toracat@elrepo.org> - 1.3-3
