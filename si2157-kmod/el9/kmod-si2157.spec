...
- Source code unchanged from 9.1 GA kernel

* Fri Jan 26 2024 Tuan Hoang <tqhoang@elrepo.org> - 0.0-5
- Rebuilt against RHEL 9.3 errata kernel 5.14.0-362.18.1.el9_3

* Wed Nov 08 2023 Akemi Yagi <toracat@elrepo.org> - 0.0-4
...
* Thu Aug 11 2022 Akemi Yagi <toracat@elrepo.org> - 0.0-1
- Initial build for RHEL 9
- Source code from RHEL 9.0 GA kernel
