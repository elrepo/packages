...
/* 
 * The following patches are required to build on RHEL5 - <phil@elrepo.org>
 *
 * Required for patch 'Check for ACPI resource conflicts' [2009-01-07]
 * acpi_check_resource_conflict is not defined in linux/acpi.h on the RHEL5
 * 2.6.18 kernel so lets define it here - <phil@elrepo.org>
 */
...
/*
 * Required for backported patch 'Fix in7 on IT8720F' [2010-07-09]
 * pr_notice and pr_fmt are not defined in linux/kernel.h on the RHEL5
 * 2.6.18 kernel so lets define them here - <phil@elrepo.org>
 * Note: Added in kernel-headers-2.6.18-238 [RHEL5.6]
 */
#ifndef pr_fmt
...
/*
 * Required for patch 'Add support for the IT8721F/IT8758E' [2010-10-28]
