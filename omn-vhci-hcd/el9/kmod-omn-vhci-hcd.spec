...
Source1:	modprobe-omn-vhci-hcd.conf
...
Patch0: 	vhci.patch
# ELRepo patch to fix up the Makefile for rpmbuild and mock
Patch1: 	ELRepo-Makefile-omn-vhci-hcd.patch
...
echo "override usb-vhci-hcd * weak-updates/%{kmod_name}" >> kmod-%{kmod_name}.conf
echo "override usb-vhci-iocifc * weak-updates/%{kmod_name}" >> kmod-%{kmod_name}.conf

%patch0 -p1
%patch1 -p1

%build
KVERSION=%{kmod_kernel_version}.%{_arch} %{__make}
...
%config %{_sysconfdir}/modprobe.d/modprobe-%{kmod_name}.conf
%doc %{_defaultdocdir}/kmod-%{kmod_name}-%{version}/

%changelog
* Tue Sep 22 2026 Tuan Hoang <tqhoang@elrepo.org> - 1.15-1
