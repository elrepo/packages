...
%changelog
* Wed May 22 2024 Akemi Yagi <toracat@elrepo.org> 43.100.00.00-2
...
* Tue Nov 14 2023 Philip J Perry <phil@elrepo.org> 43.100.00.00-1
- Rebuilt for RHEL 8.9
- Source code updated from RHEL kernel-4.18.0-513.5.1.el8_9.x86_64

* Sun Jan 15 2023 Philip J Perry <phil@elrepo.org> 42.100.00.00-2
...
* Sat Nov 13 2021 Philip J Perry <phil@elrepo.org> 37.101.00.00-1
- Rebuilt for RHEL8.5
...
* Tue May 18 2021 Philip J Perry <phil@elrepo.org> 35.101.00.00-1
- Rebuilt for RHEL8.4
- Source code updated from RHEL kernel-4.18.0-305.el8.x86_64
- Use patch to revert removed devices

* Fri Dec 18 2020 Philip J Perry <phil@elrepo.org> 34.100.00.00-2
- Fix updating of initramfs image
  [https://elrepo.org/bugs/view.php?id=1060]

* Wed Nov 04 2020 Philip J Perry <phil@elrepo.org> 34.100.00.00-1
- Rebuilt for RHEL8.3
- Source code updated from RHEL kernel-4.18.0-240.el8.x86_64
  [maintained at https://github.com/elrepo/packages/tree/master/mpt3sas-kmod/el8]
  
* Tue Apr 28 2020 Philip J Perry <phil@elrepo.org> 28.100.00.00-3
- Rebuilt for RHEL8.2
...
* Sun Jun 23 2019 Philip J Perry <phil@elrepo.org> 27.101.00.00-1
