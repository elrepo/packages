...
* Tue Jun 22 2021 Philip J Perry <phil@elrepo.org> 1.2.0-8
- Revert to RHEL kernel-4.18.0-305.el8.x86_64 source code
  [https://elrepo.org/bugs/view.php?id=1102]

* Thu Jun 03 2021 Philip J Perry <phil@elrepo.org> 1.2.0-7
...
* Mon Nov 09 2020 Akemi Yagi <toracat@elrepo.org> - 1.2.0-6
- Add dracut conf file to ensure module is in initramfs

* Tue Nov 03 2020 Akemi Yagi <toracat@elrepo.org> - 1.2.0-5
- Rebuilt against RHEL 8.3 GA kernel

* Wed Oct 21 2020 Akemi Yagi <toracat@elrepo.org> - 1.2.0-4
- Rebuilt against kernel-4.18.0-193.28.1.el8_2 (https://elrepo.org/bugs/view.php?id=1047)

* Wed Apr 29 2020 Akemi Yagi <toracat@elrepo.org> - 1.2.0-3
- Rebuilt against RHEL 8.2 kernel

* Thu Nov 07 2019 Akemi Yagi <toracat@elrepo.org> 1.2.0-2
- Rebuilt against RHEL 8.1 kernel

* Wed Jul 17 2019 Akemi Yagi <toracat@elrepo.org> 1.2.0-1
